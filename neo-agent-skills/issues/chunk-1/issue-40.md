...
updatedAt: '2026-09-03T16:31:15Z'
githubUrl: 'https://github.com/neomjs/neo-agent-skills/issues/40'
...
> Consumer caller files remain separate leaves under #14.
...
|---|---|---|---|---|---|
| `neo-agent-brain/.github/workflows/<caller>.yml` (new) | `#18` body: "Consumer caller files remain separate leaves under #14" | Invokes `reusable-pr-baseline.yml` on `pull_request` | none — absence is the current state | caller header in `reusable-pr-baseline.yml` | Brain default-branch workflow listing (10 files, no caller) |
