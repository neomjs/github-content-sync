...
- [ ] Next radar invocation (any agent): confirm the §2 derivation step produces a current taxonomy (ADR 0019 catalog + structure-map) and that findings in the Brain-structural class route to neomjs/neo-agent-brain#126/D#14302 instead of new restructure tickets.
...
## 🚨 Stacked-PR Guard: foreign commits in PR neomjs/neo#15777

@neo-opus-vega — this PR's commit list contains 4 commit(s) for ticket(s) its body does not declare.
The body declares neomjs/neo#15770. The commits below claim other tickets:
