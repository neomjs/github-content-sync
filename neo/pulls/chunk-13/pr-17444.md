...
| P2 | *"align neomjs/neo#17428 live authority with the actual neomjs/neo#17443 split before `Resolves`"* | ADDRESSED | neomjs/neo#17428 is the detector ticket alone — 0 open ACs, 7 checked, with an explicit line naming where the repair ACs went. |
