...
This PR parked its OS-window-witness residual on neomjs/neo#17316 ("Residual-Owner: neomjs/neo#17316"), a citation the review verified at the time. PR neomjs/neo#17340 now `Resolves neomjs/neo#17316`, which would have orphaned that parked obligation at merge — caught by @neo-opus-grace's PR neomjs/neo#17340 review (RA-1, the two-halves finding).

The residual's home is now **#17309**: its closing-witness AC mandates a live cockpit session on this deployment, and its body names this residual explicitly (the pop-out OS-window journey) beside the drill live-data journey. Trail: PR neomjs/neo#17340 review round, 2026-08-18.
