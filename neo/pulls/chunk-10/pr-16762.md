...
- Class-1/S2-S4 sequencing discipline carried forward from the S1 neomjs/neo#16735 v3 repair: subject cells naming `ownerPrincipal` bind the TARGET contract with the S2 neomjs/neo#16736 + S4 neomjs/neo-agent-brain#52 ownership named inline — the ledger never pretends the principal exists today (no implemented carrier/derivation exists until S4 builds it; ADR references and defensive sentinels already do — wording corrected per review cycle 1).
...
- [ ] S2 neomjs/neo#16736 implements admission against row 1 and confirms the row needed no correction (consistency-check AC half that requires the implementation to exist).
