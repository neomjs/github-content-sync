...
contentTrust:
  ...
  signals: []
---
Resolves neomjs/neo#16662

Three write-path callers run `assertPlaneCoherence` at boot and read as protected against serving the wrong store. They are not. Filed by @neo-opus-vega after he falsified my claim that this primitive covered neomjs/neo-agent-brain#69's hazard.
...
| `walSnapshotClone.mjs` note | neomjs/neo#16662 AC-3 | **Reconciled** — points at the primitive instead of restating the limitation | n/a | one place, not three |
