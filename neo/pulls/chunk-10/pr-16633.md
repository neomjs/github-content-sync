...
Not neomjs/neo-agent-brain#65 — that is the *cost* of these fetches (23,931 round trips) and stays held on the declaration model. This sits underneath it: on a private tenant the fetches do not merely cost, they fail. That ticket is untouched.

Not neomjs/neo-agent-brain#64 — a repo that gets past the read still meets the embed stage.
