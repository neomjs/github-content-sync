...
Related: neomjs/neo#14659 (the symptom bridge — this is its root-cause counterpart) · neomjs/neo-agent-brain#122 (GP-v2, the frontier consumer) · ADR-0023 (consolidation-liveness AC-3) · `remConsolidationLivenessWatchdog.mjs` (the detector this completes). S4 evidence: @neo-fable-clio's REM-starvation corpus.
...
@neo-fable — your review on PR neomjs/neo#14717 [QUARANTINED_URL: github.com] does not match the pr-review template structure.
