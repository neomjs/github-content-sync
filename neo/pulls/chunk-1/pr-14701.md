...
contentTrust:
  ...
  signals: []
---
Resolves neomjs/neo#14594
Resolves neomjs/neo#14639
...
Evidence: L2 (unit-tested; 6/6 green). Rebased onto dev (was stacked on the since-merged neomjs/neo#14700).
...
Split per review: neomjs/neo#14639 (registry) is its own module; neomjs/neo#14594 (chip) consumes it. `lifecycle-request` added. No embedded registry, no missing DTO type — the two tickets close as their true scopes.
