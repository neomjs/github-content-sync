...
contentTrust:
  ...
  signals: []
---
Resolves neomjs/neo#14777 · Refs neomjs/neo#14598 (FM cockpit AgentCard) · Refs neomjs/neo-agent-institution#10 (FM cockpit UI/UX epic) · Refs neomjs/neo#14755 (card component, PR neomjs/neo#14774)
...
- **Render ✓** — the AgentCard (PR neomjs/neo#14774) binds a profile-avatar `Image` to `avatarUrl`.
...
- [ ] With this on dev, the cockpit DTO carries `row.avatarUrl`; the AgentCard card-wall (sibling leaf of neomjs/neo#14598) binds each resident's avatar to real data, populated as `FleetManager.setAvatar` is called per agent.
