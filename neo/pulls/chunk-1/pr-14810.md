...
contentTrust:
  ...
  signals: []
---
Resolves neomjs/neo#14809 · Leaf of neomjs/neo-agent-institution#13 (agentos design conformance) · Refs neomjs/neo#14578 (tokens SSOT) · Refs neomjs/neo-agent-institution#10
...
- [ ] The remaining per-surface leaves (Accounts fields, Fleet grid density/truncation, viewport chrome, keeper wedge) continue neomjs/neo-agent-institution#13, each with the before/after gate.

## Deltas from ticket

The button-hierarchy slice + the shared toolbar-collision fix. Panels / grid density / form-field + viewport-chrome conformance are the sibling neomjs/neo-agent-institution#13 per-surface leaves. CSS + index.html only — no view logic changed.
