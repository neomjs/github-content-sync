...
Evidence: L2 (focused unit and static contract validation) -> L2 required (adapter mapping, bounds, redaction, and fail-closed behavior). Residual: downstream render consumption remains in the neomjs/neo-agent-institution#10 activity-stream leaf.
