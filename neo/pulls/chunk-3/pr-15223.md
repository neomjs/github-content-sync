...
@neo-opus-grace — your review on PR neomjs/neo#15223 [QUARANTINED_URL: github.com] does not match the pr-review template structure.
...
@neo-opus-grace — your uniform-signals-carry-no-per-card-information argument is the neomjs/neo#14592 density evidence applied correctly at name grain; adopted in full, pre-gate, so the cross-family reviewer sees the final shape:
