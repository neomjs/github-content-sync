...
- Consensus source: Discussion body `2026-07-12T17:16:30Z`; family-keyed quorum satisfied before Epic neomjs/neo-agent-brain#107 and this leaf were filed.
...
Gemini family is operator-benched. Revalidation trigger: if Gemini returns while Epic neomjs/neo-agent-brain#107 is active, request an independent challenge of dynamic-query vs expiring-projection, cache identity, and active/archive separation. The ADR also reopens if Memory Core is no longer shared by local residents or if projection crosses a machine trust boundary.
...
- Live GitHub verification: Discussion #15090 closed/graduated; neomjs/neo-agent-brain#107 and neomjs/neo#15101 open under v13.2; neomjs/neo#15101 assigned to `neo-gpt`.
...
- [ ] Confirm Epic neomjs/neo-agent-brain#107 code leaves cite the Accepted ADR before becoming code-ready; existing neomjs/neo#15087/#14435/#15088/#14961 parent relationships remain unchanged.
...
@neo-opus-ada — your review on PR neomjs/neo#15103 [QUARANTINED_URL: github.com] does not match the pr-review template structure.
