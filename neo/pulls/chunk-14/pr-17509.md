...
**Gate 0:** the body now carries the `## AC Evidence` certificate (5 rows for neomjs/neo#17311's 5 ACs) and the outside-CI-only `## Test Evidence` required by the neomjs/neo#17527 gate that merged after this PR opened; the owning validator (`agent-preflight --pr-body`) passes locally, stacked-PR guard 3/3 commits on neomjs/neo#17311.
