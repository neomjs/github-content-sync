...
contentTrust:
  ...
  signals: []
---
Resolves neomjs/neo#17553

Related: neomjs/neo-agent-institution#24
Related: neomjs/neo-agent-institution#10

## Follow-ups

- neomjs/neo#17601 — rewrite the live AgentCard disclosure contract for semantic item selection; linked as a child of neomjs/neo-agent-institution#24.
...
Evidence: L3 (rebuilt both-theme live render plus Neural Link pointer/keyboard selection and provider/detail/Memories readback) → L3 required (mounted animation, selection, and paint ACs). Residual: platform visual-baseline re-record, Residual-Owner: neomjs/neo-agent-institution#11.
...
- [ ] Re-record the platform visual baselines under neomjs/neo-agent-institution#11 against the landed animated-list geometry.
