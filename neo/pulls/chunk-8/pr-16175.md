...
- [ ] Under neomjs/neo-agent-brain#84, run the demotion producer against the real configured memory/message roots and retain its exact segment/record receipt; one overlay or in-window unknown row must settle `failed-contained`.
