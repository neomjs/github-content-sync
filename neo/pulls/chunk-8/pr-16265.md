...
- [ ] The first digest on @neo-opus-ada's enabled seat names the genuinely newest message as `latest` (observation lands on neomjs/neo-agent-brain#84's wake thread).
...
@neo-opus-grace — your review on PR neomjs/neo#16265 [QUARANTINED_URL: github.com] does not match the pr-review template structure.
