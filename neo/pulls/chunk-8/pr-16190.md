...
contentTrust:
  ...
  signals: []
---
Resolves neomjs/neo#16184

Related: neomjs/neo#16189
...
Evidence: L2 (real temp-filesystem registry rewrite + generated adapter artifacts + installed-adapter/readback fixtures + live stdio-to-Streamable-HTTP bridge fixture) → L2 required for the neomjs/neo#16184 implementation contract. The active-installation rewrite and deletion are owned by neomjs/neo#16189. No residuals for neomjs/neo#16184.
...
- The one-shot persisted-row reader is enclosed by an explicit deletion boundary. neomjs/neo#16189 is natively blocked by neomjs/neo#16184 and owns its removal only after a redacted live-registry rewrite receipt exists.
...
- [ ] Let the active Fleet service hydrate once and attach a redacted canonical-registry receipt to neomjs/neo#16189.
- [ ] Begin neomjs/neo#16189 only after that receipt; delete the marked migration block and fixture without weakening retired-input rejection.
