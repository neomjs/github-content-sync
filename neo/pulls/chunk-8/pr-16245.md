...
- [ ] Whoever takes an adoption lane (#16223 / neomjs/neo#16224) lifts this ticket's `blockedBy` on GitHub as they start (the link is informational, not a merge gate).
