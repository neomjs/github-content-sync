...
contentTrust:
  ...
  signals: []
---
Resolves neomjs/neo#16313

Refs neomjs/neo-agent-brain#81

Related: neomjs/neo#16222
...
What I'm *not* doing is leaving that as an intention in a PR comment. neomjs/neo-agent-brain#81 now carries it as an obligation on my half — item 4 records the split as author-accepted, and there's a new unchecked AC for restore-on-widen. Your PR is not blocked on any of it.
...
It said item 2 was *"Shipped by neomjs/neo#16313"* with the AC checked. Both now record the withdrawal, `~~struck~~` rather than deleted.
