...
contentTrust:
  ...
  signals: []
---
Resolves neomjs/neo#16256

Related: neomjs/neo-agent-brain#136, neomjs/neo#11133
...
- More decisively: **the pull request's head object is frequently absent from the local clone.** Replaying PR neomjs/neo#16255 — `git cat-file -e ddf522a6fe^{commit}` fails, and `git merge-base --is-ancestor ddf522a6fe <branch>` exits **128**, an error, not a `false`.
...
Warning: PR neomjs/neo#16255 for branch 'ticket-16253' merged at 2026-08-01T11:27:27Z.
