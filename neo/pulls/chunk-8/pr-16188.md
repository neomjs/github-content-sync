...
- [ ] During the operator cutover window, stop the legacy local orchestrator, prove one container resident owns non-local work while the host retains wake delivery only, and record the witness under neomjs/neo-agent-brain#84.
