...
contentTrust:
  ...
  signals: []
---
Resolves neomjs/neo#15330

Related: neomjs/neo-agent-brain#96
...
Evidence: L3 (focused security coverage plus a real bundled stack accepting both child attestations and reporting `diagnosticPathsIsolated: true` before a separately scoped browser-launch failure) → L3 required (the live diagnostic-isolation AC). No residuals for neomjs/neo#15330.
...
- [ ] Use merged `dev` for the synchronized bilateral neomjs/neo-agent-brain#96 window and append its full public receipt to that ticket.
