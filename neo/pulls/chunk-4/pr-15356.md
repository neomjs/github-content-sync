...
contentTrust:
  ...
  signals: []
---
Resolves neomjs/neo#15352
Related: neomjs/neo-agent-brain#136, neomjs/neo#15340
...
The cost: the PR silently inherits another PR's fate. On mine it also produced a **false merge-order constraint** broadcast to the operator during a live merge window (*"merge neomjs/neo#15342 before neomjs/neo#15349"*), void the moment I rebased.

Evidence: L2 (the predicate falsified against neomjs/neo#15349's exact shape + run against all 17 live open agent PRs) → L2 required for a mechanical CI guard. No residuals.
...
```
AC-1  neomjs/neo#15349's exact original shape (body: Resolves neomjs/neo#15325; commits carry neomjs/neo#15273) → 2 foreign flagged
...
AC-3  multi-ticket body (Resolves neomjs/neo#15325 + Related neomjs/neo#15294) accepts commits for both → 0 foreign
...
- [x] A commit claiming a ticket the body does not declare **fails**, naming the SHA(s) + foreign ticket id(s) — verified on neomjs/neo#15349's shape.
