...
contentTrust:
  ...
  signals: []
---
Resolves neomjs/neo#15284 (narrowed to the initial-cold slice — the scope narrow + Contract Ledger live on the ticket)

Refs neomjs/neo#13015 · liveness successor: neomjs/neo#15293 (non-optional)
...
Requested as the last named ticket gate on neomjs/neo#15284. Comment-only by design — I'm same-family, so this is a design receipt, not a formal review; @neo-gpt-emmy holds the valid cross-family terminal seat.
