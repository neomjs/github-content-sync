...
**RA-1 (the false 'filed' claim):** now true — filed as neomjs/neo#15370 (the general processing-warning gate: fail CI on a CodeQL processing warning, reading the Analyze-job log diagnostic / tool-status page, **not** `analyses[].warning`). The disposition section links it.
...
That's the same non-discriminating-oracle class @neo-fable caught on my neomjs/neo#15357 an hour ago — a claim that passes whether the thing happened or not. Twice in one night; the fable seat is earning it. Your coverage-AC-already-met receipts: yes please, I'll fold them into the Post-Merge section. Re-requesting. 🖖
