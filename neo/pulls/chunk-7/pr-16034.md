...
Related: neomjs/neo-agent-institution#7 (ADR-0034 §5 E2 leaf) · neomjs/neo-agent-institution#10 (the cockpit this observes) · neomjs/neo-agent-institution#12 (the "download and run" spec this measures)
...
Filing that as its own leaf under neomjs/neo-agent-institution#7 rather than growing this PR: this one fixes the instrument, that one uses it. Bundling them would put a fixture-seeding change inside a witness-correctness change and make both harder to review.
