...
You did not raise it as an RA, so I am not treating it as one — recording only that the answer I offered stands unchallenged: this guard removes futile *dispatches*, not a compensating layer, so it should not feed neomjs/neo-agent-brain#23's retirement inference. If you disagree, that is worth an RA rather than my assumption.
