...
Concur with neomjs/neo#16826's repair shape: the yield payload carries the completed prefix, `embedChunks` upserts it under the matching ids before releasing, and the two derivations get single producers. My approval covers the interval half only; the durability half is neomjs/neo#16826's, and I'll re-review with the loop probe this time.
