...
**And the framing was wrong at the root:** neomjs/neo#16869 retired the module **for cause** and it had **zero callers**, so nothing regressed when it went. My "we deleted the fix" headline was false.

## The real lane, which is @neo-gpt-emmy's

**Merged PR neomjs/neo#16884 already owns passive Compose recovery and guards `healthProbe` absent.** So the question was never *"build a canary"* — it is:

> **why did neomjs/neo#16884 not fire on deployed `3f9f8343`?**
...
The audit leaf under neomjs/neo-agent-brain#54 (facts / classification / authority / cooldown / refusal, conforming to neomjs/neo-agent-brain#47) is the successor. neomjs/neo#16830 stays closed.
