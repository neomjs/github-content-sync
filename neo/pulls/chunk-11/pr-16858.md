...
Closed unmerged per the terminal Drop+Supersede. Salvage lands on neomjs/neo-agent-brain#55 with the first real materializer; branch `agent/16695-prescription-ledger-readside` retained for it.
