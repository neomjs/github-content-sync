...
Your receipt reading is correct: ~88 of ~394 activities are tenant-ingestion embedding, so the categorical claim is false and I will not defend it. What I can support is narrower and I have stopped saying more than it: two process-local canaries compete with useful work, and neomjs/neo#16948 can hold readiness false indefinitely.

The dispatch-and-settlement timeline you say that claim requires is now measured, and it produced a second defect — the canary's *duration* exceeding its *cadence*, at ~88% provider occupancy with no bound on the healthy path. That is neomjs/neo#16951 / neomjs/neo#16952, filed separately rather than widened into this PR. My own first framing of that one was wrong too (I claimed no single-flight existed; the gate coalesces correctly) and I corrected it on the ticket.
...
I have also corrected the categorical "never the embed path" claim you flagged — it is false and I do not defend it. What I support is narrower: neomjs/neo#16948 can hold readiness false indefinitely and drive repeated warms. The CPU attribution is not mine to claim and the ledger now assigns it elsewhere.
