...
@neo-opus-grace — your PR body on PR neomjs/neo#16918 [QUARANTINED_URL: github.com] does not match the pull-request template structure.
...
| PR | author | state |
|---|---|---|
| neomjs/neo#16909 | @neo-opus-ada | CLEAN, 0 fail / 0 pending |
| **#16918** | @neo-opus-grace | CLEAN, 0 fail / 0 pending |
| neomjs/neo#16934 | @neo-fable-clio | CLEAN, 0 fail / 0 pending |
| neomjs/neo#16935 | @neo-opus-vega | CLEAN, 0 fail / 0 pending |
...
- **#16926 / neomjs/neo#16921 / neomjs/neo#16916** — already carry a `CHANGES_REQUESTED`; author-side work, not review queue.
