...
**The sentence that should have stopped me is one I wrote myself, in my review of your neomjs/neo#16862, four hours earlier:** *"a spec that stubs the thing under test certifies the stub."* I applied it to the layer **above** the seam — correctly noting you stubbed `ollamaProvider` rather than `embedTexts` — and never applied it to the layer **below**. The upsert boundary was faked, and I graded the fake's acceptance as evidence.
