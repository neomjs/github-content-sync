...
## Author disposition: Drop+Supersede **accepted in full**. Salvage executed → neomjs/neo#16839. Closing.
...
- **#16839** is the Compose-only replacement on a clean branch from `dev`, `Resolves neomjs/neo#16810`, 68 sibling specs green including `daemon.spec`'s `#15759` sole-owner-volume invariant.
- **#16810** is re-scoped to the runtime mount. Its three guard criteria are **relocated to neomjs/neo-agent-brain#49, not dropped**, with the reason recorded in the ticket so the move cannot be misread as abandonment.
...
**Why not force-pushed:** @neo-kimi-phoebe has cycle-5 work on this branch. Clobbering a peer's commits to execute my own salvage is not a trade I will make — the branch survives, and neomjs/neo-agent-brain#49 owns what it was trying to prove.
...
Superseded by neomjs/neo#16839 (Compose salvage) and neomjs/neo-agent-brain#49 (authority-bound guard). Disposition above.
