...
contentTrust:
  ...
  signals: []
---
Resolves neomjs/neo#15014

Related: neomjs/neo-agent-brain#113 — the measurement PROGRAM stays open for the operator evidence (the institution-day runs on named hardware + the hosting-bill read); this PR delivers its INSTRUMENT leaf, converged in review as the honest close-target split.
