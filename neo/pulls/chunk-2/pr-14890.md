...
## Merge coordination
Both this PR and neomjs/neo#14888 touch `GoldenPathSynthesizer.mjs` in **different regions** (this = the `buildDeclaredIntentFallback` method + its caller; neomjs/neo#14888 = the Concept Slice append/write). No overlapping hunks, but **merge neomjs/neo#14888 first** (it is green + cross-family-routed and ahead); this branch rebases trivially onto the result.
...
Related: neomjs/neo#14882 (parent fix this completes), neomjs/neo-agent-brain#122 (epic), neomjs/neo-agent-brain#117 (direction-attribution vocabulary).
