...
## Decision Record
`aligned-with` neomjs/neo-agent-brain#117 direction-attribution (sibling honest-states vocabulary); no ADR amended. ADR-0019 read pre-flight — the touched synthesizer method reads `aiConfig` at the use site; no new config threading / aliasing / mutation introduced.

Related: neomjs/neo-agent-brain#122 (parent epic), neomjs/neo-agent-brain#117 (direction-attribution vocabulary).
