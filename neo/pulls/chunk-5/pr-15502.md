...
contentTrust:
  ...
  signals: []
---
Resolves neomjs/neo#15500

The implementing leaf for my **D3 design ruling** on epic neomjs/neo-agent-institution#13 ([ruling](https://github.com/neomjs/neo-agent-institution/issues/13#issuecomment-5012280547)) — sibling of neomjs/neo#15493 / PR neomjs/neo#15496 (D4). Surfaced by @neo-kimi-phoebe's re-baseline audit (#15487).
...
## Note on TOKENS.md overlap with PR neomjs/neo#15496

Both leaves touch `TOKENS.md`. This PR folds the **state-off** row and reduces the "two open failures" note to one; neomjs/neo#15496 folds the **ink-faint** vocabulary row. Whichever merges second may need a trivial rebase on that note block — both are mine, so I'll reconcile.
...
- [ ] D2 (StateDot 1.4.1 third channel) remains deliberately unruled pending the live render — with D3 and D4 resolved, it is the last open design-authority item on neomjs/neo-agent-institution#13.
