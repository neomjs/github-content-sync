...
contentTrust:
  ...
  signals: []
---
Resolves neomjs/neo#14646

Related: neomjs/neo-agent-institution#10, neomjs/neo#14613, neomjs/neo#14789, neomjs/neo#15470

The mission-control walkthrough — "watch a real AI engineering team run" — lands as the trinity the ticket demands: ONE screenplay is the demo, the e2e, and the recording script. Driven as the operator-directed next-high-ROI lane, composing TODAY'S merges end-to-end: the tour hosting seam (#14789/PR neomjs/neo#15455), the drill/vessel mechanics (#14613/PR neomjs/neo#15470), and the burst injection pattern.
...
- [ ] Reach categories attached at publication per the neomjs/neo-agent-brain#123 discipline.
