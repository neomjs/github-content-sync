...
2. **Runner stays distinct** from the neomjs/neo#15149 shadow emitter — this is the exhaustive→admitBatch production path; later PR/Discussion leaves reuse *this* normalizer.
