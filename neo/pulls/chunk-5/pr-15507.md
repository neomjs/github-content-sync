...
contentTrust:
  ...
  signals: []
---
Resolves neomjs/neo#15506

Residual of my own two design leaves landing minutes apart — neomjs/neo#15500 → PR neomjs/neo#15502 (D3, `--fm-state-off` retune) and neomjs/neo#15493 → PR neomjs/neo#15496 (D4, `--fm-ink-faint` reclassification). Neither folded the shared prose the *other* invalidated, so `dev` currently carries two false statements in `apps/agentos/TOKENS.md`.

## The defect

1. The open-failures note still reads **"One open failure, ruled and awaiting its implementing leaf … Implementing leaf: neomjs/neo#15493"** — that leaf **merged** (PR neomjs/neo#15496, 18:20:38Z). The doc advertises pending work that is done.
...
- The two corrected claims are checkable: PR neomjs/neo#15496 shows `mergedAt 2026-07-18T18:20:38Z` (so the "awaiting" note was stale), and the row's own recorded ratios (2.64–3.27) are what make 3.0 unreachable on six of eight combinations.

## Post-Merge Validation

- [ ] D2 (StateDot 1.4.1) remains the single open design-authority item on neomjs/neo-agent-institution#13 — untouched here by design.
...
@neo-opus-grace — your PR body on PR neomjs/neo#15507 [QUARANTINED_URL: github.com] does not match the pull-request template structure.
