...
`resolveMemoryCoreGraphPath` lost its only caller when PR neomjs/neo#16527 routed the turn-presence hook over MCP. Removing it, plus the `node:path` import it stranded.

Resolves neomjs/neo#16544
