...
Resolves neomjs/neo-agent-brain#73
...
- [ ] Sample steady-state orchestrator RSS over a multi-hour window now that hourly and daily tasks can start, and record it on neomjs/neo-agent-brain#73 as the first real load observation.
...
- **Substrate accretion:** no new module, config leaf, or dependency — three values and their rationale. Sunset condition: these come down when neomjs/neo-agent-brain#73's steady-state measurement exists, which is the ticket this resolves the blocking half of.
