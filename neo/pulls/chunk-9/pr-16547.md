...
|---|---|---|---|
| `cloneIfMissing` clone form | neomjs/neo#16546 | `clone --mirror --filter=blob:none` for transport URLs | Remote ignores the filter ⇒ `KB_GITMIRROR_CLONE_FAILED`, mirror removed, **no** silent full-clone fallback |
