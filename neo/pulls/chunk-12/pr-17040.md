...
**Disposition per your salvage map:** generator, validator, spec, and npm script are discarded with this close. The docs' two-lane introduction and slot-truth/bump principles get rebound to the measured runtime receipt as post-release work under neomjs/neo-agent-skills#8/#17037 — nothing new lands before the release. The deployment handoff consumes tonight's measured fixed decision directly (the freeze-safety receipt is on neomjs/neo#17024, and the letter is filled from it — no manifest in the path).
