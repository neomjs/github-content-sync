...
`NODE_ID_PATTERN` rejected a **live, currently resolvable** GitHub id. Issue neomjs/neo#1's comment is `MDEyOklzc3VlQ29tbWVudDU1NzAwNzEyNg==` — `012:IssueComment557007126` — and `node(id:)` still resolves it.
