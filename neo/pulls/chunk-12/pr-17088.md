...
Evidence: L2 (98 focused unit tests, including a real disposable child killed and settled before FIFO continuation) → L3 required (live zero-unload observation across three supervisor intervals). Residual: AC13, Residual-Owner: neomjs/neo-agent-brain#131.
