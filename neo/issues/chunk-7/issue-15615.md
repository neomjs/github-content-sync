...
**Decision Record impact:** `none` — additive detection inside an existing self-defense surface; no ADR conflict. Parent: Epic neomjs/neo-agent-brain#154 (organism self-defense).
...
- Epic neomjs/neo-agent-brain#154 (parent) · neomjs/neo-agent-brain#152 (P8 link-quarantine lineage; the incident instance note lives there) · neomjs/neo#12674 (bare-name seeding tell) · #12992 (engagement-bait class) · neomjs/neo#13352 (credibility-then-backlink class) · D#15194 (host thread)
