...
4. Negative wake-proof: a suppressed message must NOT fire; a live SENT_TO_ME must land in the running session (the neomjs/neo#12913 bidirectional proof shape).
...
neomjs/neo#15572 (roster + graph), neomjs/neo#15394-line (OpenCode wake adapter precedent), neomjs/neo-agent-brain#95 (wake policy), neomjs/neo#12913 (the bidirectional wake-proof shape), seat-pointers: Iris harness experiment record.
...
- 2026-07-19T17:47:29Z @neo-kimi-phoebe added the `enhancement` label
- 2026-07-19T17:47:29Z @neo-kimi-phoebe added the `ai` label
- 2026-07-19T17:47:29Z @neo-kimi-phoebe added the `model-experience` label
- 2026-07-19T17:48:08Z @neo-kimi-phoebe cross-referenced by #15580
- 2026-07-19T17:48:33Z @neo-kimi-phoebe assigned to @neo-kimi-phoebe
- 2026-07-19T19:50:40Z @neo-kimi-iris cross-referenced by #94
- 2026-07-19T19:56:31Z @neo-kimi-phoebe unassigned from @neo-kimi-phoebe
- 2026-07-19T19:57:35Z @neo-kimi-phoebe assigned to @neo-kimi-iris
- 2026-07-19T20:12:40Z @neo-kimi-iris cross-referenced by PR #15588
- 2026-07-19T20:27:27Z @neo-kimi-iris referenced in commit `65304b6` - "feat(ai): route kimi-server wakes by SessionStart envelope authority (#15579)"
- 2026-07-19T20:48:12Z @neo-kimi-iris referenced in commit `54a8ba3` - "test(ai): update wake-subscription schema assertions for the kimi-server adapter (#15579)"
- 2026-07-19T21:08:43Z @neo-kimi-iris referenced in commit `601d302` - "docs(ai): recommend harnessTargetMetadata.cwd for multi-checkout seats (#15579)"
- 2026-07-19T21:18:37Z @tobiu referenced in commit `753cfc7` - "feat(ai): add the kimi-server wake adapter for A2A wake delivery (#15579) (#15588)

* feat(ai): add the kimi-server wake adapter for A2A wake delivery (#15579)

* feat(ai): route kimi-server wakes by SessionStart envelope authority (#15579)

* test(ai): update wake-subscription schema assertions for the kimi-server adapter (#15579)

* docs(ai): recommend harnessTargetMetadata.cwd for multi-checkout seats (#15579)"
- 2026-07-19T21:18:37Z @tobiu closed this issue
