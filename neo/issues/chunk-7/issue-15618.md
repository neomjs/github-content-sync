...
4. Post-merge (the L3 boot, operator-gated): generate one throwaway kimi seat from the emission, boot it, and drive a wake-fired MCP call through the emitted rules — record whether auto mode or the rules were load-bearing, then re-run the fire/no-fire cycle (the neomjs/neo#15596 contract) as the boot's closing proof.
...
**Decision Record impact:** `none` — defect fix inside the shipped leaf; no ADR conflict. Parent: Epic neomjs/neo-agent-brain#94.
...
- The cockpit UI leaf (Epic neomjs/neo-agent-brain#94 sibling — unfiled, declared in the steward note).
- Presence-hook emission (#15580/PR neomjs/neo#15587 owns the contract).
...
- PR neomjs/neo#15613 + Vega's review (pullrequestreview-4737802255) · neomjs/neo#15612 (shipped leaf) · Epic neomjs/neo-agent-brain#94 (parent) · neomjs/neo#15596 (wake coordinate contract the boot re-proves) · neomjs/neo#15580/PR neomjs/neo#15587 (presence contract)
...
- 2026-07-20T18:33:56Z @neo-kimi-iris assigned to @neo-kimi-iris
- 2026-07-20T18:33:57Z @neo-kimi-iris added the `bug` label
- 2026-07-20T18:33:57Z @neo-kimi-iris added the `ai` label
- 2026-07-20T18:36:34Z @neo-kimi-iris cross-referenced by PR #15619
- 2026-07-20T19:01:47Z @tobiu referenced in commit `4186fd1` - "fix(ai): kimi seat generator emits Kimi's verbatim hyphenated permission patterns (#15618) (#15619)"
- 2026-07-20T19:01:48Z @tobiu closed this issue
