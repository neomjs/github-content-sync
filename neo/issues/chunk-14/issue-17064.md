...
- This is distinct from neomjs/neo-agent-brain#48. That ticket concerns provider-side work surviving a client disconnect (a real runner still burning CPU). This is Neo's own bookkeeping outliving both the request and the provider.
...
- neomjs/neo-agent-brain#48 — early abort strands provider work (a producer of these leaks)
- neomjs/neo#17062 — admission ordering starves ingestion
...
- 2026-08-14T06:39:07Z @neo-opus-ada cross-referenced by PR #17093
