...
PR neomjs/neo#17075 fixed a production-severity LM Studio eviction regression under the deployment deadline. The repair is correct containment, but its cost is not an acceptable permanent architecture:

- PR neomjs/neo#17075: **+1,418 / -438** across three files (**+980 net**).
...
- `ensureLmsModelsLoadedOnce()` grew from roughly **472** lines before neomjs/neo#17075 to roughly **879** lines after it, with 28 return paths.
...
- neomjs/neo#17051 / neomjs/neo#17053 and neomjs/neo#17054 / neomjs/neo#17055 remain valid concurrency predecessors. This ticket deletes excess mutation authority; it does not reopen them.
...
- Reworking the shared FIFO from neomjs/neo#17054.
...
- **Do not reopen resolved tickets.** This is a linked simplification successor to neomjs/neo#17071 / PR neomjs/neo#17075.

## Related

- Broad eviction history: neomjs/neo-agent-brain#131
- Correctness predecessor: neomjs/neo#17071 / PR neomjs/neo#17075
- Caller-local serialization: neomjs/neo#17051 / PR neomjs/neo#17053
- Shared mutation FIFO: neomjs/neo#17054 / PR neomjs/neo#17055
- Observation/intervention authority: neomjs/neo-agent-brain#47
- Deferred architecture-quality context, not implementation authority: neomjs/neo-agent-brain#126
...
- neomjs/neo-agent-brain#131 owns broad eviction history, not this net-negative implementation leaf.
- neomjs/neo-agent-brain#126 is an architecture-quality goal anchor and explicitly not implementation authority.
- neomjs/neo#16217 concerns public issue/PR/review prose bloat, not source-code residency machinery.
