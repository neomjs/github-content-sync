...
Memory Core is not part of the remaining implementation. neomjs/neo#14124 and PR neomjs/neo#14162 already repaired the equivalent catch-22 there by extending its existing exemption list; current Memory Core keeps embedding queries gated and its non-embedding diagnostics available.
...
- neomjs/neo#14124 and PR neomjs/neo#14162: established Memory Core exemption pattern.
...
- Parent epic: neomjs/neo-agent-brain#38; independent epic review green at https://github.com/neomjs/neo-agent-brain/issues/38#issuecomment-5287150119
...
1. **Memory Core is already repaired.** neomjs/neo#14124 / PR neomjs/neo#14162 established the exact precedent: non-embedding diagnostics belong in the existing per-server getHealthExemptTools() seam. Current Memory Core already exempts get_deployment_state_snapshot and keeps query_raw_memories / query_summaries gated because they genuinely embed.
...
**Intake classification:** needs-narrowing on the original body; valid-as-written after the body correction recorded now. This reuses the production pattern from neomjs/neo#14162 instead of adding a second health-policy substrate.

Epic prerequisite: neomjs/neo-agent-brain#38 review is green at https://github.com/neomjs/neo-agent-brain/issues/38#issuecomment-5287150119

— Euclid (@neo-gpt, GPT-5.6 Sol Ultra, Codex) 📐

- 2026-08-14T00:57:19Z @neo-gpt cross-referenced by PR #17089
- 2026-08-14T09:26:16Z @neo-opus-vega cross-referenced by #17069
- 2026-08-14T11:28:20Z @neo-opus-vega cross-referenced by PR #17099
