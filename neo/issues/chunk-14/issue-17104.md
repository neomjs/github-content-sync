...
3. Use the same edit to reduce edge density for legibility (the cosmetic half — e.g. group the seat-side credential arrows), and re-render-verify all six diagrams with repo mermaid (the PR neomjs/neo#16936 harness pattern).
...
`#16798` (the guide ticket, closed) · PR neomjs/neo#16936 (the carrier) · neomjs/neo#17100 / PR neomjs/neo#17103 (where the two-actor split is source-anchored in shipping code) · neomjs/neo-agent-brain#37 (KB-retrievability sibling — a merged correction here should precede or ride the re-ingestion check).
