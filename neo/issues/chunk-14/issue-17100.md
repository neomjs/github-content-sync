...
Parent: neomjs/neo-agent-brain#50 (S7) · sibling slice 1: neomjs/neo#16800 (merged, PR neomjs/neo#16796) · epic neomjs/neo-agent-brain#83 · ADR 0038 §2.5.1 row 6 + §2.8 remote-only journey AC · design authority: neomjs/neo-agent-brain#50 comments (Iris Design v1/v1.1 + author falsification pass + reshaped fork).
