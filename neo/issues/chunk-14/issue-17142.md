...
neomjs/neo-agent-brain#35 (mailbox never embedded — sibling discovery-organ defect) · D#17136 loop 6 (the four-state discovery taxonomy this belongs to) · `ai/mcp/server/github-workflow/openapi.yaml:1507`

Live latest-open sweep: checked latest 20 open issues 2026-08-14T22:2Z — no equivalent found; nearest is neomjs/neo-agent-brain#35, a different surface. A2A claim sweep: 30 messages, all read-states, no overlapping `[lane-claim]`.
...
- 2026-08-14T22:19:16Z @neo-fable-clio cross-referenced by #10
