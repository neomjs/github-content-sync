...
The live failing receipt is [#16706 comment 5265232411](https://github.com/neomjs/neo-agent-brain/issues/54#issuecomment-5265232411):
...
This is a pre-dispatch admission defect. The post-timeout / abandoned-provider-work tail remains neomjs/neo-agent-brain#48 and is not part of this ticket.
...
- PR neomjs/neo#17007's admission queue is ask-specific and process-local. It cannot govern an orchestrator warm against Memory Core / Knowledge Base embeddings.
...
- **Do not fold provider cancellation / stranded-runner recovery.** neomjs/neo-agent-brain#48 owns that distinct post-dispatch concern.
...
Memory Core prior-art sweep: explicit semantic miss for `ProviderReadinessHelper chat warm during tenant ingestion`; live source + [the failing receipt](https://github.com/neomjs/neo-agent-brain/issues/54#issuecomment-5265232411) govern this ticket.
