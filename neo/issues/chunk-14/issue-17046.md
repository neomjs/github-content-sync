...
- [ ] A REM run on the container profile releases the heavy lease at its budget boundary; a registered waiter acquires before REM re-acquires (fixture, integrates with neomjs/neo#16561's waiter semantics).
...
neomjs/neo#16561 (lease fairness — the other half) · neomjs/neo-agent-skills#8 (retrospective family) · the 2026-08-13 external-plane receipts
