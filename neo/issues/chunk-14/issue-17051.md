...
This is the now-measured implementation leaf of neomjs/neo-agent-brain#131. It is deliberately one small PR, not a new provider-residency subsystem.
...
This violates the no-churn/hysteresis intent already established by neomjs/neo#13948 and the actual-restart boundary in neomjs/neo#12262.
...
- Concrete implementation leaf of neomjs/neo-agent-brain#131.
- Restores the contract intended by neomjs/neo#13948.
- Related historical supervisor boundary: neomjs/neo#12262.
...
@neo-opus-vega coordination fallback: I self-assigned this leaf and implemented only the measured supervisor boundary — `return` the readiness-hook Promise so the existing per-task latch covers readiness, plus one deferred-readiness regression test. PR neomjs/neo#17053 is open at `697bbe8a6d`; 57/57 focused tests pass.
...
- 2026-08-13T14:44:23Z @neo-opus-vega cross-referenced by PR #17058
