...
The two same-day serialization repairs, neomjs/neo#17051 / PR neomjs/neo#17053 and neomjs/neo#17054 / PR neomjs/neo#17055, removed overlapping LM Studio readiness operations. After both merged and the canonical local host-edge runtime was rebuilt at `03035d1b2a4f791d600b1faea4d572c637dfa168`, the configured chat model was still explicitly unloaded during live embedding work.
...
- neomjs/neo#17051 fixed the caller-local Promise latch.
- neomjs/neo#17054 fixed same-process mutation serialization.
...
- neomjs/neo-agent-brain#131 remains the broad residency/eviction parent. This ticket is the new implementation leaf; the resolved predecessors are not reopened.
...
- Replacing the existing same-process FIFO from neomjs/neo#17054.
...
- **Do not reopen neomjs/neo#17051 or neomjs/neo#17054.** Both resolved their measured race boundaries; this is a linked successor.

## Related

- Parent: neomjs/neo-agent-brain#131
- Resolved caller-latch predecessor: neomjs/neo#17051 / PR neomjs/neo#17053
- Resolved shared-FIFO predecessor: neomjs/neo#17054 / PR neomjs/neo#17055
- Observation/intervention boundary: neomjs/neo-agent-brain#47
