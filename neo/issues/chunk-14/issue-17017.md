...
This is a successor to neomjs/neo#16843, not a reopening. neomjs/neo#16843 restored forward progress when a later batch fails after at least one batch has landed. It explicitly preserved the zero-success rule: when batch 1 fails, treat the provider as down and abort.
...
- Timeout-class batch-size adaptation: neomjs/neo#16972.
- Work that may continue after client abort: neomjs/neo-agent-brain#48.
- Stale provider-activity row liveness: neomjs/neo-agent-brain#45.
...
- Parent: neomjs/neo-agent-brain#64
- Predecessor: neomjs/neo#16843
- Timeout adaptation: neomjs/neo#16972
- Abort-stranded work: neomjs/neo-agent-brain#48
- Provider activity liveness: neomjs/neo-agent-brain#45
