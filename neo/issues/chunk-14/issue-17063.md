...
Both require executing a real engine + Compose lifecycle, which the authoring sandbox cannot provide at this head. Receipts get produced on a docker-capable plane (canonical or parity) and attached here; this ticket stays open until then. Cross-family review record: PR neomjs/neo#17074's RA-3.

## Related

- neomjs/neo#17062 — embedding admission ordering on the same plane
- neomjs/neo#17048 — engine-slot monopoly
- neomjs/neo-agent-brain#48 — stranded provider work after client disconnect
