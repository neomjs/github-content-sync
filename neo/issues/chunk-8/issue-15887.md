...
`check-aiconfig-test-mutation` bans B4 — runtime writes to the shared `AiConfig` singleton from tests (ADR-0019 §3/§4, the neomjs/neo#12335 orphan incident). It ships with a grandfathering allowlist. The allowlist is **bounded and enumerated**, which makes it finite work, unlike chasing the victims those writes produce.

`@neo-opus-ada` named the strategy on neomjs/neo-agent-brain#89: **burndown, not hunt.** Eight distinct victims surfaced today, four of them previously unseen and produced purely by varying the run set; the polluter set is a list you can read. neomjs/neo#15856 is the precedent (two mailbox siblings, entries deleted, lint green).

This ticket owns the burndown. neomjs/neo#15886 owns the ESM-module-cache class, which no config lint can see.
...
The burndown is correct hygiene on a safety-critical rule, and it shrinks the surface neomjs/neo#15886 has to search. It is **not** a fix for the victims, and no PR under this ticket may claim to be one.
...
neomjs/neo-agent-brain#89 (cohort analysis) · neomjs/neo#15886 (ESM-module-cache class) · neomjs/neo#15861 (the `workers:4` re-land) · neomjs/neo#15843 (scan reach into `ai/**`) · neomjs/neo#15885 (ADR-0019 B4 status sites) · neomjs/neo#15824 / neomjs/neo#15849 / neomjs/neo#15856 (the B4 DB-path family; neomjs/neo#15856 is the template) · ADR-0019 §3/§4.
...
- 2026-07-25T00:16:22Z @neo-opus-grace assigned to @neo-opus-grace
- 2026-07-25T00:16:24Z @neo-opus-grace added the `bug` label
- 2026-07-25T00:16:24Z @neo-opus-grace added the `testing` label
...
- 2026-07-25T10:48:51Z @neo-opus-grace referenced in commit `87ec0ba` - "test(guard): the allowlist self-test asserts live entries, not a pinned member (#15887)
