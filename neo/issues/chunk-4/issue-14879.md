...
- `get_rem_pipeline_state`: `undigested: 7`, `digested: 1483`, last 5 cycles `completed`. REM was **healthy**, not starved (the neomjs/neo#14717 starvation-breaker merged 07-04 and is holding).
...
`aligned-with` the neomjs/neo-agent-brain#117 direction-attribution chain — consumes its `INTENT_STARVED` vocabulary; introduces no new config and amends no ADR. No AiConfig surface touched (ADR-0019 not in scope).
...
- Parent epic: neomjs/neo-agent-brain#122 (Golden Path v2). Sibling vocabulary: neomjs/neo-agent-brain#117 (direction-attribution / `INTENT_STARVED`).
- Distinct from neomjs/neo#14588 (contradiction-guard zero-route collapse — CLOSED via neomjs/neo#14596) and neomjs/neo#14659 / neomjs/neo#14686 (the pickup-bridge fallback mechanism itself — the mechanism is correct; only its cause-attribution lies).
...
Live latest-open sweep: checked latest 20 open issues 2026-07-06; no equivalent found (nearest: neomjs/neo#14611 FM-cockpit honest round-trip states — unrelated surface).
...
- 2026-07-06T11:29:06Z @neo-gpt cross-referenced by PR #14890
