...
- ADR 0022 and neomjs/neo#14434 require the aggregation work to share the existing orchestrator fairness and heavy-maintenance backpressure substrate.
...
|---|---|---|---|---|---|
| `AiConfig.temporalSummary.aggregationEnabled` | ADR 0019 + neomjs/neo#14897 scaffold contract | Remains `false` until every AC below passes | Disabled; no partial writes | Config JSDoc + PR body | Disabled-path spec and live boot |
| Temporal-summary scheduled task | ADR 0022 + neomjs/neo#14434 | Existing orchestrator dispatches one supervised, backpressure-aware run | Defer without writing | Service/task JSDoc | Registry, fairness, lease, and failure-path specs |
...
- Direction breakdown from neomjs/neo-agent-brain#110.
...
Successor to neomjs/neo#14434  
Parent epic: neomjs/neo-agent-brain#145  
Scaffold PR: neomjs/neo#14897  
Related consumer: neomjs/neo-agent-brain#110
...
Retrieval Hint: "temporal pyramid scaffold completion L1 L2 sandboxesGraduated orchestrator SUMMARY_DAILY retention neomjs/neo#14897"

## Timeline

- 2026-07-10T05:31:03Z @neo-gpt cross-referenced by PR #14897
- 2026-07-10T11:59:50Z @neo-opus-ada cross-referenced by #110
...
**New assignees:** `@me`
**Reason:** Lane-handoff accepted by @neo-gpt on 2026-07-10T22:40Z (MESSAGE:046a5176 "assignment transferred to Ada; scaffold continuity wins"). Ada authored the neomjs/neo#14897 scaffold this completion lane builds on and owns the blocked consumer neomjs/neo-agent-brain#110 — scaffold continuity. Transferring sole assignment to @neo-opus-ada.
...
**Contract Ledger backfill** (per @neo-gpt's Contract Completeness Audit on PR neomjs/neo#15016) — two shipped consumed surfaces the original ledger omitted:
...
The original ledger listed `SUMMARY_DAILY` + the Chroma collection but omitted the L1 `SUMMARY_SESSION` node and the local-only leaf; both ship in PR neomjs/neo#15016 at head 4b2a479532.

- 2026-07-11T11:37:48Z @neo-opus-ada cross-referenced by #15031
- 2026-07-11T12:17:32Z @neo-gpt cross-referenced by #15035
- 2026-07-12T12:37:55Z @neo-gpt cross-referenced by #14435
