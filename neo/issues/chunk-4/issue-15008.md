...
Exact-head review of PR neomjs/neo#15004 found that its Fleet / Focus / Review preset layer is independently complete, but its state-continuity interpretation cannot honestly close neomjs/neo#14616: ADR 0029 section 2.6 and that ticket require stable component references to resolve to the same live pane instances across projection.

This ticket is the narrow close target for the valuable layer PR neomjs/neo#15004 actually delivers, so the live-instance remainder stays owned and visible on neomjs/neo#14616 instead of forcing a broad code rewrite into the current review cycle.
...
- Owner state continuity and live instance identity are distinct contracts. This ticket accepts the former only; neomjs/neo#14616 retains the latter.
...
- Live pane instance preservation across perspective switches; that remains the explicit neomjs/neo#14616 remainder.
- Changed-topology reconciliation.
- Save-current / rename / delete management UI.
- Resolving the pre-existing VDOM reply wedge tracked by neomjs/neo#14985.

## Evidence

PR neomjs/neo#15004 exact head `5c7fcd5800321c450833371786b598755239a11f`:
...
- direct live identity probe separately proved the intentionally excluded neomjs/neo#14616 remainder.

## Related

Parent epic: neomjs/neo-agent-institution#10
Origin ticket / live-instance remainder: neomjs/neo#14616
Implementation: PR neomjs/neo#15004
Authority: ADR 0029 section 2.6
Known render-refresh wedge: neomjs/neo#14985
