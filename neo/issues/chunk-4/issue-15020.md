...
Found during exact-head re-review of PR neomjs/neo#15013 / ticket neomjs/neo#15014 after its four formal review actions were resolved. The meter deliberately supports Ctrl-C as a graceful early stop and still writes a provenance report, but the corrected boundary-coverage contract exposes one contained residual in that path.
...
This does not affect naturally completed windows and the report is not auto-ingested, so it is safe follow-up debt rather than a merge blocker for neomjs/neo#15013.
...
The real 24-hour / second-hardware measurement runs and billing-console read owned by parent neomjs/neo-agent-brain#113 · automatic business-metric ingestion · pricing claims.
...
Live open-issue search for “serving cost Ctrl-C requested window interrupted” returned no match. Latest-open queue checked immediately before creation; neomjs/neo#15014 is the delivered instrument ticket, not this interrupted-window residual. Memory prior-art sweep surfaced the neomjs/neo#15013 build lineage but no existing follow-up.
