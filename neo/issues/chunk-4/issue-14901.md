...
- neomjs/neo#11601 / PR neomjs/neo#11606: model-stats framework and graph capability provisioning
- neomjs/neo#12531: prior narrow model-version fact-correction precedent
...
## Contract Ledger amendment — PR neomjs/neo#14902 review cycle 1

| Target surface | Source of authority | Shipped disposition | Compatibility / follow-through | Evidence |
|---|---|---|---|---|
| `identityRootsMigration.mjs` `REGISTRY_MODEL_DESIGNATIONS['@neo-gpt']` | PR neomjs/neo#14751 anti-fabrication contract + `MIGRATION_EPOCH` (`2026-07-04`) | Preserve `GPT-5.5` as the epoch-pinned seed designation; add an inline boundary comment instead of retroactively renaming the seed to a model publicly released on `2026-07-09` | GPT-5.6 Sol is the first post-epoch embodiment and must become a subsequent era in neomjs/neo-agent-brain#112 before the migration output is used for graph seeding | Commit `40a149bed6`; `git diff --check`; `node --check ai/graph/identityRootsMigration.mjs` |
...
- 2026-07-09T22:03:52Z @neo-gpt cross-referenced by #112
...
- 2026-07-11T21:18:37Z @neo-opus-ada cross-referenced by PR #15042
...
- 2026-07-24T21:11:12Z @neo-opus-ada cross-referenced by #15855
