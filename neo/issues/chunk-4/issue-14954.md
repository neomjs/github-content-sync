...
PR neomjs/neo#14950 delivers the first-run R3b onboarding path from neomjs/neo#14916: a dry-run-first setup CLI generates the four committed identity ceremony surfaces on a non-integration branch. Exact-head review at `f978bdbb9fa3ad7855938e183b57f9450eb0ffcd` verified a real four-surface write, zero writes on a same-input rerun, a green generated identity-roots pin, and 10/10 hosted checks.
...
- neomjs/neo#14916's original rotation mode and PR-body draft are not part of PR neomjs/neo#14950's onboarding-only slice;
...
- Rotation reuses the ceremony planner but must respect the accepted era boundary: current engine truth never enters durable roots, and the July-4 migration seed is never retrojected. The Sol neomjs/neo#14901/#14902 arc is the hindcast fixture.
...
4. Add rotation mode using neomjs/neo#14902 as the hindcast: emit the correct review-gated surface plan, preserve migration epoch pins, and exclude model designation from durable roots.
...
| rotation plan | neomjs/neo#14902 epoch disposition + neomjs/neo-agent-brain#112 era boundary | update only rotation-owned public/stat/evidence surfaces | never mutate migration seed or root engine truth | help + PR draft | Sol hindcast fixture |
...
- [ ] Rotation mode passes the neomjs/neo#14901/#14902 hindcast and never writes engine designation into durable roots or retrojects the migration seed.
...
Source: neomjs/neo#14916 / PR neomjs/neo#14950  
Era boundary: neomjs/neo-agent-brain#112  
Hindcast: neomjs/neo#14901 / PR neomjs/neo#14902  
Onboarding capstone: neomjs/neo#14937

Live duplicate sweep: latest 20 open issues plus all-state title/body search at 2026-07-10T06:24Z found no equivalent. Exact-head review evidence is retained in PR neomjs/neo#14950.
...
- 2026-07-16T21:14:39Z @neo-opus-grace cross-referenced by #114
...
- the only PR found for this contract is merged precursor neomjs/neo#14950; no open successor or competing implementation exists;
- neomjs/neo#14954 remains assigned to @neo-gpt and the parent neomjs/neo#13015 Stage-2.5 mapping gap is resolved.

Classification: **valid-as-written**. I am claiming the full divergence + rotation + PR-draft contract as one coherent implementation lane; no micro-PR split. ADR-0012, ADR-0018, ADR-0019, current source, and the neomjs/neo#14901/#14902 hindcast are the implementation authorities.

- 2026-07-19T04:41:43Z @neo-gpt cross-referenced by PR #15560
- 2026-07-19T05:19:36Z @tobiu referenced in commit `5bc6620` - "feat(agentos): complete identity ceremony convergence (#14954) (#15560)"
- 2026-07-19T05:19:37Z @tobiu closed this issue
