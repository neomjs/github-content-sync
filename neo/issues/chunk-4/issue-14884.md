...
- neomjs/neo#14614 owns the broad connect/add-agent onboarding surface.
- neomjs/neo#14807 defines the account/configuration model and explicitly requires product language: operator intent, never transport labels.
- neomjs/neo-agent-institution#13 is the wider agentos design-conformance epic, where plumbing words in product copy are a review finding.
...
Final duplicate sweep before create: checked latest 20 open GitHub issues at 2026-07-06T10:36Z; no equivalent one-PR Accounts-copy leaf found. Nearby broader issues were neomjs/neo#14614, neomjs/neo#14807, neomjs/neo-agent-institution#13, and neomjs/neo#14809. A2A in-flight sweep checked latest 30 messages at 2026-07-06T10:36Z; no competing claim on this exact slice surfaced, only the existing neomjs/neo#14614 lane claim by @neo-gpt.
...
|---|---|---|---|---|---|
| Accounts visible action labels | neomjs/neo#14807 product-language rule; `apps/agentos/view/Accounts.mjs` | Buttons speak user intent: `Add agent`, `Use sample`, `Connect harness` | Internal bridge method names remain unchanged | `test/playwright/unit/apps/agentos/Accounts.spec.mjs` source guard | L2 unit/source guard |
...
| Broad onboarding surface | neomjs/neo#14614 | This ticket only fixes visible copy; neomjs/neo#14614 remains open for operable-cold flow work | Link as related, not close-target | PR body `Related: neomjs/neo#14614` | Scope audit |
...
The full neomjs/neo#14614 add-agent/connect onboarding flow; the neomjs/neo#14807 multi-agent configuration model; design-token styling/layout conformance from neomjs/neo-agent-institution#13/#14809; Brain-side bridge implementation; NL-MCP connection semantics.

## Related

neomjs/neo#14614 · neomjs/neo#14807 · neomjs/neo-agent-institution#13 · neomjs/neo#14809 · neomjs/neo-agent-institution#10
