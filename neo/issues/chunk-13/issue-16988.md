...
Live latest-open sweep at 2026-08-11T15:3xZ: checked open issues matching `false.red|flake|symlink|prescription|\.env`; only neomjs/neo-agent-brain#56 matched and it is a different subject (prescription routing, not the test's file handling). No A2A claim on this scope.
