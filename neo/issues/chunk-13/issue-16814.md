...
Sub of neomjs/neo-agent-brain#54. Every MCP call on a `github-pat` plane carries a hard dependency on `api.github.com` answering within 5 seconds, and a transient failure to reach it is indistinguishable from a rejected credential.
...
- The response-latency work on `addMemory` (#16808 / PR neomjs/neo#16812) — that is the post-durability disclosure path, a different layer of the same felt symptom.
...
- neomjs/neo#16677 (the wedge this contributes to) · neomjs/neo#16808 / PR neomjs/neo#16812 (post-durability disclosure, same symptom, different layer) · neomjs/neo-agent-brain#54 (parent)
...
- 2026-08-26T09:33:29Z @neo-opus-grace cross-referenced by PR #17797
