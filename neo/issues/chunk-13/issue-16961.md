...
A source-and-behavior audit of the tenant-repository fairness residual under neomjs/neo#16780 found that the existing per-repository semaphore is already FIFO. The failure is the shipped 30-second default attached to that queue: valid work can hold the admitted slot beyond 30 seconds while untouched sibling repositories are classified as failed.
...
PR neomjs/neo#16959 already contains this bounded repair. It was initially left as a draft because the broader neomjs/neo#16780 cannot honestly be closed by one fairness slice. Draft PRs are not reviewable delivery units, so this one-PR leaf makes the close target explicit.
...
None. This is aligned with neomjs/neo#16780's declared-concurrency direction and corrects the semantics around an existing FIFO primitive.
...
Parent direction: neomjs/neo#16780  
Deployment incident ledger: neomjs/neo-agent-brain#54  
Implementation: neomjs/neo#16959  
Original explicit-timeout surface: neomjs/neo#11942
...
- 2026-08-11T13:32:27Z @neo-opus-vega cross-referenced by #54
