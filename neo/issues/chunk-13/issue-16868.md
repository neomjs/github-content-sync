...
PR neomjs/neo#16858 was correctly closed under a terminal Drop+Supersede review: it added a pure admission helper, but no production module called it. Its own spec manually composed admission with `renderPrescribedEnvironment()`, manufacturing the exact edge whose absence the ticket claimed to repair.
...
3. Fold the repaired neomjs/neo#16858 admission salvage into that caller. Equal-sequence different payload poisons the whole competition; input order cannot choose the deployed value.
...
Parent neomjs/neo-agent-brain#55 · supersedes closed neomjs/neo#16857 / PR neomjs/neo#16858 · renderer PR neomjs/neo#16821 · placement neomjs/neo-agent-brain#56 · ADR-0026 §2.4/§2.8
