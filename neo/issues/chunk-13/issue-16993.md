...
Live latest-open sweep at 2026-08-11T16:4xZ: `rebuild|agent os|local-agent-os|clone|provision` over open issues surfaced neomjs/neo-agent-brain#84 and neomjs/neo-agent-brain#90; neither mentions `neo-ai-secrets`, `mcp-auth-token`, or the single-seat dependency (0 matches each). No duplicate.
