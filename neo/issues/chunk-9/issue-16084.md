...
neomjs/neo#15825 tracks the unresolved mechanism behind mailbox read-state resurfacing. Fresh direct and broadcast probes on 2026-07-28 preserved their receipts across new Memory Core stdio lifetimes, so reconnect alone is a bounded negative—not a root cause. The parent must remain open until a real recurrence identifies the dropping or skipping path.
...
- [ ] The implementation PR references neomjs/neo#15825 without closing it and changes no mailbox service, daemon, repair, configuration, or sender-provenance behavior.

## Out of Scope

- Naming or fixing the positive read-state loss mechanism tracked by neomjs/neo#15825.
- Autonomous sender provenance and authorization design in D#16083.
- Stale/orphaned runtime liveness tracked by neomjs/neo-agent-brain#121.
...
- Parent mechanism investigation: neomjs/neo#15825
- Sender-provenance design (separate scope): https://github.com/orgs/neomjs/discussions/16083
- Runtime freshness (separate scope): neomjs/neo-agent-brain#121

## Duplicate Sweep

- Semantic ticket sweep: no equivalent dedicated diagnostic found; nearest results were neomjs/neo#15825, neomjs/neo#15448, neomjs/neo#15322, and historical mailbox investigations.
...
- 2026-07-28T10:59:20Z @neo-gpt assigned to @neo-gpt
- 2026-07-28T10:59:20Z @neo-gpt added the `enhancement` label
- 2026-07-28T10:59:21Z @neo-gpt added the `ai` label
- 2026-07-28T10:59:21Z @neo-gpt added the `testing` label
- 2026-07-28T11:02:41Z @neo-gpt cross-referenced by PR #16085
- 2026-07-28T11:20:25Z @neo-gpt referenced in commit `371a237` - "feat(ai): add carrier-aware mailbox read-state probe (#16084)"
- 2026-07-28T11:20:26Z @neo-gpt referenced in commit `21c9d65` - "fix(ai): align mailbox probe identity matching (#16084)"
- 2026-07-28T11:39:55Z @tobiu referenced in commit `38caf6c` - "feat(ai): add carrier-aware mailbox read-state diagnostic (#16084) (#16085)

* feat(ai): add carrier-aware mailbox read-state probe (#16084)

* fix(ai): align mailbox probe identity matching (#16084)"
- 2026-07-28T11:39:55Z @tobiu closed this issue
