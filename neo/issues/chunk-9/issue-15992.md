...
This is the non-blocking hardening sibling produced by the post-graduation source step-back on [Discussion #15958](https://github.com/orgs/neomjs/discussions/15958) and neomjs/neo#15990. Epic neomjs/neo-agent-brain#90 remains the sole coordination parent.

neomjs/neo#15990 closed via PR neomjs/neo#16038 with the one-PR ship-now baseline: source-safe activation foundation, canonical rosterless `github-pat` parity, authenticated readiness, and the landed neomjs/neo#15807 / PR neomjs/neo#15983 overlay adaptation. This ticket follows that merged baseline; it remains independently claimable and must not block neomjs/neo#15805 or the pilot neomjs/neo#15806.
...
neomjs/neo#15990 removes the fail-open activation predicate and preserves every existing state safely enough to ship the local profile. This successor completes the architectural ownership contract without delaying that baseline.
...
- **G2a single owner:** completed here after neomjs/neo#15990 establishes safe unconditional activation.
...
- [ ] All neomjs/neo#15990 baseline behavior remains green, including rosterless first-subject policy, GitLab empty-allowlist compatibility, authenticated readiness, provider-independent parity CI, and stdio preservation.
...
4. **Regression:** the full neomjs/neo#15990 baseline suite stays green.

## Out of Scope

- Canonical dev Compose mode, host-port binding, readiness secret, first-subject policy, GitHub local-profile auto-provision, or PR neomjs/neo#15983 overlay adaptation; neomjs/neo#15990 owns those ship-now surfaces.
- Seat-config generator output; neomjs/neo#15805 owns generated provider-subject and secret-reference wiring.
- A new liveness route; neomjs/neo-agent-brain#140 owns the measured trigger.
...
- **Making this ticket a release blocker for the local seat.** neomjs/neo#15990 is the baseline close-target; this is a successor.
...
- **Nested epic or meta-ticket.** neomjs/neo-agent-brain#90 already coordinates the shared outcome; this is one one-PR leaf.

## Related

Parent epic neomjs/neo-agent-brain#90 · predecessor neomjs/neo#15990 · generator neomjs/neo#15805 · pilot neomjs/neo#15806 · CI topology neomjs/neo#15807 / PR neomjs/neo#15983 · source D#15958 · ADR 0019 · ADR 0020.

## Unresolved Liveness

- neomjs/neo#15990 is closed via PR neomjs/neo#16038. This ticket is independently claimable and does not block neomjs/neo#15805 or neomjs/neo#15806.
...
Retrieval Hint: `query_raw_memories("D#15958 neomjs/neo#15990 Streamable HTTP auth ownership proxy ingress hardening")`

## Timeline

- 2026-07-26T14:33:12Z @neo-gpt cross-referenced by #15990
- 2026-07-26T14:34:01Z @neo-gpt cross-referenced by #90
