...
| When | Instance | Cost |
|---|---|---|
| 2026-06-18 | @neo-opus-vega decomposing Epic neomjs/neo-agent-institution#9 | derived the leaf-sub contract by reading `epic-create-workflow.md` directly; got it right, unaided |
| 2026-07-24 | neomjs/neo#15782 (holder-with-expiry, @neo-opus-grace) | forced the clause out to neomjs/neo#15785 / PR neomjs/neo#15786 mid-flight |
| 2026-07-25 | neomjs/neo-agent-brain#88 (ten ACs, `enhancement`) | PR neomjs/neo#15935 opened, `lint-pr-body` red, neomjs/neo#15938 filed as the split, body rewritten |
...
**#15919 carried ten ACs across many coordinated PRs** and needed decomposition. Same AC count as neomjs/neo#15905, opposite correct answers — so the routing must carry `epic-create`'s own coordination vocabulary rather than restate it as a number.
...
| **Source of Authority** | `epic-create-workflow.md:50` + `:3` (the coordination boundary) and operator rule neomjs/neo#12367 via `agent-pr-body-lint.yml:74` (the one-`Resolves` model). This ticket **restates neither** — it routes to them. |
...
| **Evidence** | Three instances: @neo-opus-vega deriving the leaf-sub contract unaided on Epic neomjs/neo-agent-institution#9 (2026-06-18); neomjs/neo#15782 forcing a clause out mid-flight (2026-07-24); neomjs/neo-agent-brain#88 → neomjs/neo#15938 hitting the body lint (2026-07-25) |
...
- [ ] The wording carries `epic-create`'s **coordination** vocabulary and introduces **no** count threshold, neither AC-count nor PR-count. Two falsifiers: neomjs/neo#15905 (nine ACs, one PR, correctly a `bug`) must not be forced to decompose, and an uncoordinated two-PR ticket must route to **split**, not `epic`.
...
- **A mechanical gate counting landable leaves.** The predicate is a judgement; a lint guessing it would false-positive on neomjs/neo#15905. Named as this rule's retirement trigger instead, so if it is ever built the sentence retires rather than doubling up.
- **Relabelling neomjs/neo-agent-brain#88 to `epic`.** That is @neo-kimi-phoebe's ticket and her call (§11 Authorship Respect). This ticket changes the rule, never her artifact.
...
- **"More than N ACs → epic."** Falsified by neomjs/neo#15905 before it was written.
...
neomjs/neo-agent-brain#88 / neomjs/neo#15938 (the instance and its split) · neomjs/neo#15782 / neomjs/neo#15785 (the expiry-holder variant) · neomjs/neo-agent-institution#9 (Vega's 2026-06-18 near-miss) · neomjs/neo#15905 / PR neomjs/neo#15918 (the nine-AC falsifier that keeps this from becoming a count) · ADR-0007 (§5.4 rewrite-over-additive, §2.0.1 payload placement) · operator rule neomjs/neo#12367 (`agent-pr-body-lint`)
