...
**Neo already has the mechanism that should have prevented this.** neomjs/neo#14000 / neomjs/neo#14007 / neomjs/neo#14085 shipped `splitOversizedEmbeddingChunk`, and neomjs/neo#17155 made the guard measure every provider — its own JSDoc is emphatic: *"The band is provider-independent, so the guard measures EVERY provider — `recognized` is a diagnostic flag for skip receipts, never a licence to skip the measurement."*
...
Population split, same run: 25,759 vendor chunks (50 over band, 200k–1.6M estimated tokens — hopeless by any band, and a source/include-manifest question tracked on neomjs/neo-agent-brain#149) and 61,088 non-vendor chunks, of which **2** exceed the slot. `50 + 2 = 52` reconciles the deployment's observed `errors=50`.
...
`none` — restores the intent neomjs/neo#14000/#17155 established.
...
- Vendor chunks of 200k–1.6M tokens: no band saves them and no parser can cut them; that is the per-tenant include manifest on neomjs/neo-agent-brain#149.
...
- Graduating a chunk that cannot be delivered at all — neomjs/neo#17336.
...
neomjs/neo#14000 · neomjs/neo#14007 · neomjs/neo#14085 (the splitter) · neomjs/neo#17155 (guard measures every provider) · neomjs/neo#16972 (identical-size retry on the same refusal) · neomjs/neo#17336 (undeliverable graduation) · neomjs/neo#17337 (the probe that reports healthy through this) · neomjs/neo-agent-brain#149 (never-ingest set for vendor trees) · neomjs/neo#17296
