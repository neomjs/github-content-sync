...
## The Fix (design-first, neomjs/neo-agent-institution#20-adjacent but functional scope)
...
Epic neomjs/neo-agent-institution#10 (parent) · sibling: memories pop-out (filed together) · neomjs/neo-agent-institution#20 (design pass) · neomjs/neo#17307 (memories wire hardening — same boundary)
