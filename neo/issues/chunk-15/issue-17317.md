...
neomjs/neo#14617 (the auto-hide rail arc this surface belongs to) · neomjs/neo#17313 (shell-geometry sibling from the same session) · neomjs/neo-agent-institution#20 (Memories pane as the operator-hit fixture) · Epic neomjs/neo-agent-institution#10 (consumer; this ticket is engine-side)
