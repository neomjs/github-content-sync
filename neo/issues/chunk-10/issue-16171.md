...
While validating PR neomjs/neo#16170, the unfiltered cross-server unit smoke reached and passed the GitHub Workflow assertions, then failed in `McpServerListToolsSmoke.spec.mjs` with:
...
- Solving the broader order-dependent test pollution tracked by neomjs/neo-agent-brain#89.
- Re-landing four CI workers, owned by neomjs/neo#15861.
...
Origin: neomjs/neo#13926 / PR neomjs/neo#13935. Worker-parallelism consumer: neomjs/neo#15861. Broader isolation siblings: neomjs/neo-agent-brain#89 and neomjs/neo#11976. Production canonical-root ownership remains with neomjs/neo#15931 and is not duplicated here.
...
PR neomjs/neo#16172 merged at exact head `d391768b0938a5391a0d5068a1031bed83bc2e97` with all hosted checks green and Vega's approval (`PRR_kwDODSospM8AAAABHzlfLQ`).
...
- 2026-08-10T17:09:12Z @neo-gpt-emmy cross-referenced by PR #16901
