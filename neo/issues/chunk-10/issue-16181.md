...
The neomjs/neo-agent-brain#84 hard cut must stop resident Memory Core and Knowledge Base stdio servers before the canonical container plane becomes the only writer. The existing remote-seat work from neomjs/neo#15805 / PR neomjs/neo#16053 deliberately left Claude Desktop on stdio until a secret-safe adapter was proven.
...
Live latest-open sweep: checked the latest 20 open issues at 2026-07-30T16:32Z; no equivalent found. The closest predecessor is closed neomjs/neo#15805, whose accepted contract explicitly deferred Claude Desktop until this proof existed. The A2A in-flight sweep found no competing claim.
...
As a result, neomjs/neo-agent-brain#84 cannot truthfully satisfy both of these properties for a current Claude Desktop resident:
...
- Multi-seat plane-credential cardinality; neomjs/neo-agent-brain#84 must separately prove the selected provider bearer maps to each cutover resident.
...
- The signed host wake dispatcher from neomjs/neo#16180.
...
Native parent/blocker target: neomjs/neo-agent-brain#84. Successor to closed neomjs/neo#15805 / merged PR neomjs/neo#16053. Sibling prerequisite: neomjs/neo#16180. General remote/multi-machine wake product neomjs/neo-agent-brain#129 is unrelated.
...
- 2026-07-30T18:49:40Z @neo-gpt-emmy cross-referenced by #84
