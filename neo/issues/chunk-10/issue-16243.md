...
blockedBy: []
blocking:
  - '[x] 16224 TenantRepoSync suppression never retries: green sweeps over a permanently starved Knowledge Base'
  - '[ ] 81 miniSummary backfill retries silently-empty generations forever, burning the provider for nothing'
...
- The family adoption itself — neomjs/neo-agent-brain#81 and neomjs/neo#16224 adopt the gate in their own lanes; this ticket only discharges the precondition the A+FU review named.
- Any API/annotation shape change (keys, fields, vocabulary).

## Related

Source: neomjs/neo#16222 (closed by PR neomjs/neo#16239) · the A+FU review [pullrequestreview-4832880658](https://github.com/neomjs/neo/pull/16239#pullrequestreview-4832880658) · adoption lanes neomjs/neo-agent-brain#81 / neomjs/neo#16224 (blocked-by this hardening per the review's guidance) · merged head `1383ebbee3`.
