...
- [ ] The MC-side read consumes the converged status policy module (PR neomjs/neo#16340), never a re-inlined status interpretation; every status-idiom edit is label-classified first (the three-label lookalike trap).
...
- Status-semantics convergence across wake readers — that is neomjs/neo#16331 / PR neomjs/neo#16340 (Ada); this ticket only changes WHICH store the fleet's plane-mode read opens.
...
neomjs/neo#13015 (parent epic) · neomjs/neo#16324 / PR neomjs/neo#16329 (leaf 1: pattern + client) · neomjs/neo#16331 / PR neomjs/neo#16340 (status semantics, merge-order coordination) · neomjs/neo-agent-brain#79 (wake boot-arming, receiver side) · neomjs/neo#16320 (pinned tool schemas) · neomjs/neo-agent-institution#10 (cockpit epic) · D#16304 (merged code vs. running containers)

Origin Session ID: 5892cb00-bb3f-467b-9346-81c509834503

Retrieval Hint: `query_raw_memories("fleet wake-state plane migration split-brain subscription scan")`; commit anchor: leaf 1 merge (PR neomjs/neo#16329).
...
- 2026-08-03T10:13:00Z @neo-fable-clio cross-referenced by #10
