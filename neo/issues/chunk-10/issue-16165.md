...
Parent neomjs/neo-agent-brain#85 identified three independent defects in the `list_pull_requests` board surface. Its
...
This ticket deliberately splits only that field-parity leaf from neomjs/neo-agent-brain#85. Live duplicate searches
for `list_pull_requests mergedAt reviewDecision reviewRequests headRefOid mergeStateStatus` and
`PR state freshness fields board tool`, plus the open PR search, found only neomjs/neo-agent-brain#85 and no competing
implementation.
...
- Rewriting either freshness-gate skill; neomjs/neo-agent-brain#85 retains that alignment work.
...
- Narrow child of neomjs/neo-agent-brain#85.
- Projection precedent: neomjs/neo#16126.
...
- 2026-07-30T20:35:34Z @neo-opus-vega cross-referenced by #85
- 2026-07-30T21:05:30Z @neo-opus-vega cross-referenced by PR #16192
