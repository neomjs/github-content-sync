...
The canonical local Orchestrator became Docker-unhealthy for roughly 20 minutes while a legitimate session-summary child was still running. The child completed, `orchestrator-state.json` advanced, and the same health command passed again. The operational observation is recorded on [#16167](https://github.com/neomjs/neo-agent-brain/issues/84#issuecomment-5145363514).
...
Related: neomjs/neo#11937

Related: neomjs/neo#12025

Related: neomjs/neo#15759

Related: neomjs/neo-agent-brain#84

Related: neomjs/neo-agent-brain#81
