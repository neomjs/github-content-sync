...
Native sub-issue of neomjs/neo-agent-brain#90. The parity pilot shipped snapshot, replay, promotion/demotion, and evidence evaluators in `#15806` / PR `#16037`, but one honest terminal remains unreachable: `demoted-clean` requires proof that no overlay write reached the durable plane.
...
- The operator-run maintainer-machine cutover owned by sibling neomjs/neo-agent-brain#84.
...
Parent neomjs/neo-agent-brain#90 · pilot tooling neomjs/neo#15806 · plane identity neomjs/neo#15799 · in-process dual WAL drains neomjs/neo#15802 · machine dogfood neomjs/neo-agent-brain#84.
