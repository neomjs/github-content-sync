...
Found while diagnosing neomjs/neo#16577 (tenant ingestion), by reading the embed path rather than by an incident. **No live loss is attributed to this path** — see the explicit non-claim below. It is filed as a reachable data-loss route with a success-shaped report, not as a post-mortem.
...
**Not claimed:** this does not explain the corpus losses tracked in neomjs/neo-agent-brain#66. Those changed the collection id (`ab75f86b` → `32fd2c88`), which is delete-and-recreate; row deletion leaves the id intact. This is a **distinct** path, and conflating them would be exactly the "quotation as root cause" trap.
...
- Retro-attributing neomjs/neo-agent-brain#66's corpus losses. Different mechanism; not reopened here.
...
- neomjs/neo#16563 — same misreport shape on the export surface.
- neomjs/neo#16577 / neomjs/neo-agent-brain#64 — the tenant-ingestion lane this was found beside.
- neomjs/neo-agent-brain#66 — corpus-loss incidents. **Different mechanism**; listed to prevent conflation.
...
07:54  neo tenant sync: ingested=24590 deleted=17550 embeddings=0 errors=1
       -> the DELETE succeeded, the EMBED refused (that half was neomjs/neo#16587, now merged)
07:54  KB = 50
...
Cluster: D#15605 (hub) · D#12034 · neomjs/neo-agent-brain#65 (held pending the acquisition decision) · neomjs/neo-agent-brain#64 · neomjs/neo#16591 · D#16586 (adjacent, durability axis).
...
- 2026-08-26T15:07:30Z @neo-opus-vega cross-referenced by #65
