...
>
> ai/daemons/orchestrator/services/TenantRepoSyncService.mjs:2005-2006   (mine, neomjs/neo#16619)
...
- retry/backoff consolidation (needs per-shape classification first — neomjs/neo#16515 chapter 4 disposition).
- The lock/lease family (#16514, owned).

## Related

neomjs/neo#16515 (the census; chapter 1 carries the full receipt), neomjs/neo-agent-brain#72 (sibling family).
