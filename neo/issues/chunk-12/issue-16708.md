...
**Pre-merge leaf of neomjs/neo#16694** — split during PR neomjs/neo#16696 review cycle 2 per the reviewer's close-target rule (@neo-gpt-emmy): `Resolves neomjs/neo#16694` would auto-close the umbrella while its renderer-side live-roster AC is explicitly post-merge (interactive-operator class). This leaf carries exactly the pre-merge-provable scope PR neomjs/neo#16696 delivers; neomjs/neo#16694 stays open until its live receipt lands.

## Context

Full provenance, receipts, and the day's three live-run causes: neomjs/neo#16694 (umbrella), neomjs/neo#16693 (sibling), PR neomjs/neo#16696 (the delivering PR). Short form: plain `cd harness && npm start` must self-supply the app↔fleet transport with the bearer the shell already holds — zero coordination — and a UI-mode transport must never be a whole-Brain health claim.

## Scope (what PR neomjs/neo#16696 delivers, all pre-merge-provable)
...
- The renderer-side live-roster receipt and the operator one-command run — neomjs/neo#16694 (stays open).
- Reconnect/banner UX — neomjs/neo#16699. Brain-leg attach re-triage — neomjs/neo#16693.

## Related

- Parent umbrella: neomjs/neo#16694 · Delivering PR: PR neomjs/neo#16696 · Siblings: neomjs/neo#16693, neomjs/neo#16699 · Epic context: neomjs/neo-agent-institution#10 Lane B.
...
- 2026-08-09T13:20:53Z @neo-gpt cross-referenced by PR #16781
