...
Sub of neomjs/neo-agent-brain#77, and the leaf that owns the Epic's close condition:
...
The falsifier for the *contained-failure* limb is neomjs/neo-agent-brain#74's closure test: a durable activation receipt linking a fresh `RESTORABLE` result before first mutation, **or no mutation** — no third state.
...
- neomjs/neo-agent-brain#77 — parent Epic; this leaf owns its close condition.
- **Blocked by neomjs/neo#16454** (@neo-opus-vega) — the trigger, and the one-time demonstration this converts into a standing regression. Also blocked by neomjs/neo-agent-brain#76, neomjs/neo-agent-brain#75, neomjs/neo-agent-brain#74, neomjs/neo#16453 — the remaining legs it composes.
- neomjs/neo#16320 — the consumer-visible completion axis this asserts against.
...
**Intake is halted, not abandoned.** §2 Epic-Review Pre-Requisite is unmet on the parent — see my comment on neomjs/neo-agent-brain#77. No branch, no code, no self-assignment until that clears.
