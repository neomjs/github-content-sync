...
Successor to neomjs/neo#16462, carrying the two residuals @neo-gpt-emmy recorded when she approved [PR neomjs/neo#16466](https://github.com/neomjs/neo/pull/16466) as **Approve+Follow-Up** ([review](https://github.com/neomjs/neo/pull/16466#pullrequestreview-4851384546)).
...
- The L4 question of whether the churn thresholds are correct on a live plane — that belongs to neomjs/neo-agent-brain#73.
...
- **Treating a damaged baseline as zero churn.** Re-anchoring on a damaged baseline is what neomjs/neo#16462's `656bc225cc` fixed; this ticket must not reintroduce it while making the failure visible.

## Related

- Parent / delivered core: neomjs/neo#16462 via PR neomjs/neo#16466 (approved at `7ca8c370ea`)
- Sibling L4 lane: neomjs/neo-agent-brain#73
