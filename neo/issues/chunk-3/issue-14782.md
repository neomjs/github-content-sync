...
The ROADMAP gate (this mechanizes its measurement clauses) · neomjs/neo#14781 (J2/J3 host F1/F2) · the business epic's shipped metric-schema leaf (F3's substrate) · the falsifying-query discipline (recorded).
...
Operator rejected neomjs/neo#14860. It was not approved or demanded, and it must not be treated as v13.2 scope.

Current state:
- neomjs/neo#14860 is closed as not planned.
- neomjs/neo#14860 is detached from neomjs/neo#14230 and removed from the v13.2 milestone.
- Do not route F2 through neomjs/neo#14860, neomjs/neo#14672, or neomjs/neo#14676.
...
Closing as not planned, executing the operator directive already recorded on this ticket. neomjs/neo#14782 and the rejected neomjs/neo#14860 measurement scaffolding must not gate neomjs/neo#14789 or v13.2. Any future reach instrumentation needs fresh product authority rather than inheriting this rejected premise.
