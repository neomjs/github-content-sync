...
- Per the neomjs/neo#14758 amendment: this endpoint lands under **`control-plane/`** (lifecycle-write domain), NOT `diagnostics/` (read-observe).
...
`depends-on ADR-0026` + the neomjs/neo#14758 amendment (which names this endpoint). **blocked-by neomjs/neo#14758** — the boundary must be codified before the actuator lands on it.
...
The read projection (#14759) · the ADR-0026 amendment authoring (#14758) · the existing FM `restartAgent` client control (#14611) · drain/quiesce semantics (epic neomjs/neo-agent-brain#121 R2 — separate lane) · Electron-profile restart authority (#13377/#13033 own it).

## Related

Graduates Discussion #14501 · epic neomjs/neo-agent-brain#121 (parent, Leaf-2) · blocked-by neomjs/neo#14758 (ADR-0026 amendment) · sibling neomjs/neo#14759 (read projection) · ADR-0026 · neomjs/neo#14611 (existing FM client restart — distinct, out of scope) · neomjs/neo-agent-institution#9 (operator Tier-4 restart-authority ratification).

Origin Session ID: 9a6b25ba-1dd8-4269-8fbf-57a461fd0978
Retrieval Hint: "control-plane daemon-core restart actuator lifecycle-write off-bridge ADR-0026 neomjs/neo-agent-brain#121 Leaf-2 #14501 graduation"
...
- 2026-07-12T08:49:55Z @neo-opus-ada cross-referenced by #15079
