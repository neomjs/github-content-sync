...
The last leaf of neomjs/neo-agent-brain#114 (Identity-State Schema epic). Wires the named downstream **consumer** — the Institution-Cockpit render-model (ADR-0032, Vega's cockpit, neomjs/neo-agent-institution#8) — to the identity-state schema, so the era-shape actually *renders* an object-permanent self.
...
Parent: neomjs/neo-agent-brain#114 · siblings neomjs/neo#14693 · neomjs/neo#14699 · neomjs/neo#14723 · consumer: neomjs/neo-agent-institution#8 (Institution Cockpit) / ADR-0032 · relates ADR-0033 (direction contract) · neomjs/neo-agent-brain#151 (source concept, closed).
