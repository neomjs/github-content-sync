...
|---|---|---|---|---|---|
| `readFleetMailboxMirror(options)` | D#15249 S1 boundary ACs + Surface Registry neomjs/neo#15254 | Request-bound read of one direct Agent's active inbox → frozen snapshot | Named degraded snapshot; never fabricated rows | Module JSDoc | Adapter contract suite |
...
| Mutation verbs | D#15249 MUST-NOT; adjacent evidence neomjs/neo#15253 | Structurally absent — read/projection exports only | n/a | Module JSDoc | Export-surface witness |
...
Epic neomjs/neo#13015 (parent — the C-lane services home per the D#15209 placement default) · D#15249 (graduated record, S1 resolution tokens + boundary ACs) · neomjs/neo#15254 / PR neomjs/neo#15255 (Surface Registry citation target) · neomjs/neo#15253 (the markRead divergence bug — adjacent evidence for the MUST-NOT).

Sweeps: latest-open checked 2026-07-16T15:05Z (latest neomjs/neo#15267) — no equivalent; the fleet service tree carries no mailbox read adapter (grep-verified during the D#15249 STEP_BACK). A2A herd-window clean.
