...
- **ROI:** high and bounded. It reuses the existing projection mechanism, adds one generic exact-profile substrate, preserves full and `harness-embedded` behavior, and unlocks the native PoC closeout in neomjs/neo#15187 without creating a parallel registry.
