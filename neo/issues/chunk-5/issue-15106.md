...
- Hook projection storage/readers, Bird Views, `fleet-awareness-read`, or neomjs/neo#14620 UI.
...
Live latest-open sweep: checked the latest 20 open issues at `2026-07-12T20:38Z`; no equivalent found. Recent all-state A2A claim sweep: only Emmy's earlier neomjs/neo-agent-brain#107 lane-intent overlaps this scope; no foreign collision.
...
- **Epic-review prerequisite:** satisfied by Emmy's one-shot review at https://github.com/neomjs/neo-agent-brain/issues/107#issuecomment-4952696436; neomjs/neo#15106 is the only implementation child greenlit in that review.
...
**Acceptance:** self-assignment and native parent link to neomjs/neo-agent-brain#107 are verified. Branch-before-code is now authorized.
