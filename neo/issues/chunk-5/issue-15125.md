...
This is a bounded repair leaf under neomjs/neo-agent-brain#122, not a new concept-graph architecture. It restores the existing JSONL → Native Edge Graph contract before more GP2 consumers depend on it. The structured Epic-review cap is already satisfied by [Euclid's review](https://github.com/neomjs/neo-agent-brain/issues/122#issuecomment-4870597992) and [Emmy's review](https://github.com/neomjs/neo-agent-brain/issues/122#issuecomment-4952596928).

Live duplicate sweep: latest-open issues, all-state A2A claims, GitHub/Knowledge-Base/Memory-Core history, and the archived neomjs/neo#10085 projection-test precedent were checked. No equivalent open ticket exists. neomjs/neo-agent-brain#119 is adjacent but distinct: it decides MEMORY→CONCEPT anchoring and promoted-edge protection; this leaf repairs the already-committed ontology projection.
...
ADR 0024 §2.7 and `learn/agentos/ConceptOntology.md` also describe the retired inline per-message extraction path rather than the scheduled bounded harvester shipped by PR neomjs/neo#13968.
...
- Discussion #14422 Matrix-1 already permits source re-derivation while reserving promoted-edge protection for neomjs/neo-agent-brain#119. Membership and salience must therefore stay separate: surviving live edges keep their IDs and decayed weights; a still-declared but missing JSONL-owned tuple is re-derived.
...
| Projection ownership + four axes | D#14422 OQ6; neomjs/neo-agent-brain#122 carried constraints | `projectionSource` and all four unflattened axes ride every projected edge | Unknown/foreign owner is preserved, never silently adopted after migration | JSDoc + ADR 0024 | Foreign same-type preservation + axis-shape specs |
...
| Relationship salience | ADR 0024 + D#14422 Matrix-1 | Existing weight continues to decay; reconciliation does not reinforce surviving tuples | A pruned but still-declared source tuple is recreated; global protection remains neomjs/neo-agent-brain#119-owned | ADR 0024 | Forced decay/prune plus surviving-weight-preservation specs |
...
- [ ] PR evidence includes the exact live tuple audit before/after repair and `Refs neomjs/neo-agent-brain#122`.
...
- Selecting neomjs/neo-agent-brain#119's MEMORY→CONCEPT anchoring or global promoted-edge protection option.
...
- **Protect every ontology edge globally:** pre-empts neomjs/neo-agent-brain#119 and collapses membership into salience.
...
Decision sibling: neomjs/neo-agent-brain#119  
Historical ontology epic: neomjs/neo#10030  
Historical projection tests: neomjs/neo#10085  
Prior canonicalization: neomjs/neo#14502  
Prior coverage repair: neomjs/neo#14349  
