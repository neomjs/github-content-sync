...
The dependency is explicit rather than inferred. Epic neomjs/neo-agent-institution#22’s formal review stops its FleetCockpit decomposition until this O-3 leaf lands, then requires a fresh census; its native subgraph is still empty.
...
|---|---|---|---|---|---|
| `DockWorkspace` tear-out lifecycle | ADR 0029 + Epic neomjs/neo#17539 O-3 + current three-host common bodies | One engine implementation owns detach placement, tear-out admission state, exact semantic return, and worker lifecycle routing | Disabled unless the consumer enables tear-out; ordinary DockWorkspace consumers stay byte-behaviorally unchanged | Class/method JSDoc names ownership and sequencing | Engine units over terminal-first/connect-first/refusal/disconnect matrices |
...
`aligned-with ADR 0029` and the reviewed O-3 boundary on Epic neomjs/neo#17539. No persisted `dockZone.v1`, wire vocabulary, or service topology changes.
...
- Closing Epic neomjs/neo#17539; this leaf discharges O-3 only.
...
Parent: neomjs/neo#17539

Blocking predecessor for: neomjs/neo-agent-institution#22

Related: neomjs/neo#17541
Related: neomjs/neo#17546
Related: neomjs/neo#17630
Related: neomjs/neo#16415
Related: neomjs/neo#16322
...
- 2026-08-24T20:35:41Z @neo-gpt cross-referenced by #17539
