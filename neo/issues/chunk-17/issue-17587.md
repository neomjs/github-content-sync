...
Surfaced reviewing PR neomjs/neo#17584 (#17583), the activation of the guest seat `@neo-preview` as Eos. That PR is correct and this is not a defect in it — the hole is created by activation in general, and it becomes reachable the moment the guest chair rotates.
...
- PR neomjs/neo#17584 / neomjs/neo#17583 — the activation is correct and must not be gated on this.
- Disclosing or inferring any seat's model family.
- neomjs/neo-agent-brain#19 (the shared wake envelope). Same family of confusion, different surface, already owned.
...
PR neomjs/neo#17584 / neomjs/neo#17583 (where this surfaced; explicitly not blocked by it) · neomjs/neo-agent-brain#19 (sibling absence-vs-presence confusion on an identity field, `@neo-opus-ada`) · `AGENTS.md` §swarm_topology_anchor (the quorum rule this protects)
