...
PR neomjs/neo#17429 correctly removed the DevIndex source copy from Neo, but also removed the DevIndex rows from all four Portal example registries. Those registries are release-independent data: the hourly [Data Sync Pipeline](https://github.com/neomjs/neo/blob/dev/.github/workflows/data-sync-pipeline.yml) deletion-syncs `apps/portal/resources/data/**` into `neomjs/pages`, while runnable apps in that Pages tree move only with Neo releases.
...
This successor also retains its original Approve+Follow-Up scope: repair the surviving blog link and verify the pipeline-owned SEO outputs after neomjs/neo#17429.
...
- Reverting the source removal in neomjs/neo#17429.
- The DevIndex working-set round trip and frozen cursor — neomjs/devindex#9.
- Repository history rewriting — neomjs/neo#17376.
...
- neomjs/neo#17429 — removal PR that exposed the cadence split
- neomjs/neo#17421 — original removal ticket
- neomjs/neo#17376 — history rewrite this removal unblocked
- neomjs/devindex#9 — independent working-set defect
...
- 2026-08-25T15:42:05Z @dawesi referenced in commit `3a0ccb5` - "fix(portal): restore release-gated showcase entries (#17436) (#17437)
