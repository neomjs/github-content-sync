...
- After nav cut 1 (PR neomjs/neo#17452), memories is a resident south tab and detail is the rail inspector — both have natural pane-header homes for their own window verb.
- `fleetCockpitPopOut.spec.mjs` asserts the toggle references and labels; expectations follow the new mount point. **Sequencing: this lane starts only after PR neomjs/neo#17452 merges** — it edits the same spec regions.
...
Chip/tab anatomy and §04 tokens (#17269 cuts 2 / neomjs/neo#17264 own the look) · the instance switcher's chrome slot (#17328 shipped it; unchanged) · responsive/overflow behavior beyond the two named widths · pane content design (#17268).

## Related

Parent neomjs/neo#17269 (the composition authority) · epic neomjs/neo-agent-institution#10 · PR neomjs/neo#17452 (sequencing dependency: merges first) · neomjs/neo#17211 (rail sizing sibling) · neomjs/neo#17265 (density pass sibling).

Live latest-open sweep: checked latest 20 open issues at 2026-08-21T10:31Z; no equivalent found. A2A in-flight claim sweep: herd window clean (peer claims: neomjs/neo#17414/#17447 Memory-Core lanes, Grace's neomjs/neo#17376 migration).
