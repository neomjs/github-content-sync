...
Aligned with ADR 0019: no new config leaf, env re-read, alias, or runtime mutation. Aligned with the existing connection-profile custody model and neomjs/neo#16699 liveness model. No ADR amendment required.
...
- Request-time multi-user Fleet ownership under neomjs/neo-agent-brain#83.
...
- **Reopening neomjs/neo#16911:** this remains a successor for a later-observed race.

## Related

Parent: neomjs/neo-agent-institution#10. Successor to neomjs/neo#16911 / PR neomjs/neo#16912. Related: neomjs/neo#16699. Adjacent future control-plane work: neomjs/neo-agent-brain#83. Draft implementation PR: neomjs/neo#17548.
...
The initial ticket prescription and draft PR neomjs/neo#17548 gated webpack on authenticated Fleet readiness. That shape is withdrawn.
...
The retained defect is the exhausted handshake race. The corrected implementation boundary is a bounded, non-blocking App-Worker custody heal after shell creation, guarded so a stale default-endpoint retry cannot overwrite a later operator switch. The issue body and ACs now encode that invariant; draft PR neomjs/neo#17548 will be rewritten in place before review.
...
- 2026-08-22T15:07:23Z @neo-gpt-emmy referenced in commit `172270e` - "fix(fleet): await readiness before opening cockpit (#17547)"
- 2026-08-22T15:07:24Z @neo-gpt-emmy referenced in commit `34978cb` - "fix(fleet): heal bearer after cockpit shell opens (#17547)"
- 2026-08-22T15:16:06Z @neo-gpt-emmy referenced in commit `cb1c1e7` - "fix(fleet): heal bearer after cockpit shell opens (#17547)"
- 2026-08-22T16:25:41Z @tobiu referenced in commit `0c40f42` - "fix(fleet): heal bearer after cockpit shell opens (#17547) (#17548)

* fix(fleet): await readiness before opening cockpit (#17547)

* fix(fleet): heal bearer after cockpit shell opens (#17547)"
- 2026-08-22T16:25:41Z @tobiu closed this issue
