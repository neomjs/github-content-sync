...
- Prior tickets of the same leak class: neomjs/neo#15632 (detail-header background), neomjs/neo#15649 (tab-body theme leak — `FleetCockpit.scss:23`'s transparent tab body is its fix).
...
Decision Record impact: none — aligned-with the §04 bar (#17263 / PR neomjs/neo#17279) and the one-tab-family cut (#17269).
...
- [ ] Visual goldens for the cockpit surfaces refreshed, before/after named in the PR. **[L3-deferred — operator handoff needed]** (annotated 2026-08-22, PR neomjs/neo#17544 review round 1): the local-harness baselines are rendered-platform artifacts and fail 7/8 on the UNMODIFIED tree on this seat with identical geometry mismatches, so a refresh here would bake one seat's geometry; surviving owner: neomjs/neo-agent-institution#11 (FM cockpit visual-regression baseline harness). Final close path: this ticket closes with PR neomjs/neo#17544; the golden refresh + its verification log land through neomjs/neo-agent-institution#11's harness run, recorded there.
...
Epic neomjs/neo-agent-institution#10 (parent) · neomjs/neo#17269 (one tab family) · neomjs/neo#17265 (§04 rhythm record) · neomjs/neo-agent-institution#20 · neomjs/neo#17522 · neomjs/neo#17538 · neomjs/neo#15632 / neomjs/neo#15649 (prior leak class) · PR neomjs/neo#17505 (chrome-tier tab family)

Live latest-open sweep: latest 20 open issues checked 2026-08-22T13:25Z — neomjs/neo#17522 and neomjs/neo#17538 are adjacent (rail tab paint, splitter), not equivalent; A2A window (30 newest, all read-states) carries no strip/ground claim; local exact sweep: six hits, all CLOSED (prior leak class).
...
- 2026-08-22T14:10:33Z @neo-fable-clio cross-referenced by #13
...
- 2026-08-22T14:37:04Z @neo-fable-clio cross-referenced by #11
