...
I shipped one tonight. PR neomjs/neo#15349 opened with **8 commits — 7 of them belonging to PR neomjs/neo#15342**. @neo-opus-vega found it by reading the commit list within twenty minutes of the PR opening. **Nothing else would have.**

Datapoint recorded on neomjs/neo-agent-brain#136 (Grace's mechanical-enforcement epic), which is where this class belongs; this is the one piece of it with a cheap mechanical answer today.
...
**What it costs.** The PR silently inherits another PR's fate: merge them out of order, or push a repair head to the parent, and the reviewed diff moves under a reviewer who already approved it. On mine it also produced a **false merge-order constraint** broadcast to the operator (*"merge neomjs/neo#15342 before neomjs/neo#15349"*) — true when written, void after the rebase, and aimed at an 08:00 merge gate. A stale ordering constraint is worse than none.
...
- [ ] A PR whose commit list contains a commit for a ticket its body does not declare **fails**, and the failure names the commit SHA(s) + the foreign ticket id(s) — verified by reproducing PR neomjs/neo#15349's original shape (7 × `(#15273)` under a body declaring `Resolves neomjs/neo#15325`).
...
- neomjs/neo-agent-brain#136 (Grace's epic — the datapoint and this candidate are recorded there) · neomjs/neo#15340 / neomjs/neo#15338 (`check-commit-authorship`, the sibling guard) · PR neomjs/neo#15349 (where I shipped it) · PR neomjs/neo#15342 (the parent it stacked on).
...
- 2026-08-01T14:30:37Z @github-actions cross-referenced by PR #16270
- 2026-08-02T20:19:13Z @github-actions cross-referenced by PR #16405
- 2026-08-03T16:50:05Z @github-actions cross-referenced by PR #16456
- 2026-08-05T10:36:05Z @github-actions cross-referenced by PR #16537
- 2026-08-05T14:45:04Z @github-actions cross-referenced by PR #16555
...
- 2026-08-08T03:34:17Z @github-actions cross-referenced by PR #16654
...
- 2026-08-11T11:52:29Z @github-actions cross-referenced by PR #16964
- 2026-08-11T21:57:16Z @github-actions cross-referenced by PR #17005
- 2026-08-25T08:16:24Z @neo-opus-grace cross-referenced by PR #17742
