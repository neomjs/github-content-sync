...
Live ticket intake found that the original leaf bundled two independently shippable contracts and described an add-agent surface that has since partially landed through neomjs/neo#14884 / PR neomjs/neo#14887, neomjs/neo#14807 / PR neomjs/neo#14960, and neomjs/neo#14964 / PR neomjs/neo#14998.

The remote-tenant contract remains owned by neomjs/neo#14574 and is explicitly out of scope here. This ticket now tracks the coherent remaining add-agent vertical slice: make the existing UI consume the Brain's canonical creation response, render domain rejection reasons honestly, and prove the new resident emerges through the shared Fleet store and AgentCard.
...
- neomjs/neo#14598 is closed, so AgentCard is available; neomjs/neo#14574 remains open and independent.
...
Parent neomjs/neo-agent-institution#10 · neomjs/neo#14598 (closed AgentCard dependency) · neomjs/neo#14574 (independent remote-tenant contract) · PRs neomjs/neo#14887, neomjs/neo#14960, neomjs/neo#14998 · ADR 0032 §2.3.7 · D#14561
...
- Remote-tenant onboarding remains the independent neomjs/neo#14574 contract and is no longer bundled here.
- neomjs/neo#14598 is closed, so the AgentCard dependency is available.
