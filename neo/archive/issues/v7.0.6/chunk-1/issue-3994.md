...
We are in the middle of changing the permission name, see [QUARANTINED_URL: crbug.com]

Meanwhile, here's a snippet (deployed here [QUARANTINED_URL: earthy-befitting-sedum.glitch.me]) that should work on all browsers:
