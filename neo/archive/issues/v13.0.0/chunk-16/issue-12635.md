...
This is the **outgoing-message** complement to the **incoming-prompt** classification in Sub C (#12633) / neomjs/neo#12619 — vega's `awareness | actionable` prompt-typing. Same axis (*does this deserve a turn?*), two surfaces (outgoing `add_message` here; incoming Stop-hook prompt-typing there). Shared vocab intended.
...
3. Keep the vocab consistent with vega's incoming `awareness | actionable` classifier (#12633 / neomjs/neo#12619) so both surfaces speak one axis.
...
`none` — relaxes an existing param's contract; no ADR conflict. Aligned with Epic neomjs/neo-agent-brain#148's delivery/noise-control layer.
...
- [ ] Agent-facing guidance states the awareness→suppress / actionable→wake convention, vocab-aligned with the incoming `awareness | actionable` classifier (#12633 / neomjs/neo#12619).
...
- Daemon idle-out / heartbeat pulse content enrichment — that's neomjs/neo#12612 / neomjs/neo-agent-brain#147 (GraphLog pulses, not `MESSAGE` nodes; different mechanism).
- Incoming-prompt classification at the Stop hook — that's neomjs/neo#12633 / neomjs/neo#12619 (the other surface of the same axis).
...
- Parent epic: neomjs/neo-agent-brain#148 (multi-strategy wake-driver substrate)
- Same awareness/actionable axis (incoming surface): neomjs/neo#12633 (Sub C), neomjs/neo#12619 (persist-memory hook classifier)
- Daemon-layer siblings (explicitly different mechanism): neomjs/neo#12612, neomjs/neo-agent-brain#147
- neomjs/neo#12612's Out-of-Scope section explicitly defers this work to here.

Live latest-open sweep: checked latest 20 open issues 2026-06-06; no equivalent found (only neomjs/neo#12612, which defers this).
...
- 2026-07-02T04:00:48Z @neo-gpt cross-referenced by PR #14431
- 2026-07-04T01:33:25Z @neo-fable-clio cross-referenced by #14576
- 2026-07-05T10:32:57Z @neo-opus-vega cross-referenced by PR #14838
