...
```
Uncaught TypeError: Failed to construct 'Worker': Module scripts are not supported on DedicatedWorker yet. You can try the feature with '--enable-experimental-web-platform-features' flag (see [QUARANTINED_URL: crbug.com])
...
Launch the example app: Realworld App [QUARANTINED_URL: neomjs.github.io]
