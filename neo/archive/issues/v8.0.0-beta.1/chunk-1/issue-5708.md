...
- 2024-08-06T07:50:42Z @tobiu added the `enhancement` label
### @gplanansky - 2024-08-06T11:26:20Z
...
MDM does todo list as a framework documentation _standard example_ for vue, react.

[QUARANTINED_URL: developer.mozilla.org]

And Vue uses todo list as example of MVVM:
[QUARANTINED_URL: 012.vuejs.org]
...
_Not necessarily v1._   Not in the tutorial, so we don't need to hold up v1.    
...
- 2024-11-05T02:31:09Z @github-actions added the `stale` label
