...
> @Dinkh [QUARANTINED_URL: github.com] @tomayac[<img alt="" width="15" height="15" src="chrome-extension://dlebflppeeemcdpidccbiblndppbmjmh/ospo-chrome-ext-logo.png"> [QUARANTINED_URL: teams.googleplex.com]]([QUARANTINED_URL: github.com]) @michaelwasserman[<img alt="" width="15" height="15" src="chrome-extension://dlebflppeeemcdpidccbiblndppbmjmh/ospo-chrome-ext-logo.png"> [QUARANTINED_URL: teams.googleplex.com]]([QUARANTINED_URL: github.com]) [QUARANTINED_URL: youtu.be]
> 
> this part was more fun than i thought. uninterrupted widget to popup & back dragging.
