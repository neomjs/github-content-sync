...
|---|---|---|---|---|---|
| AgentOS widget child app chat intake surface | neomjs/neo#13349, ADR 0020, neomjs/neo#13355 | Captures a bounded first-widget request and exposes submit/invalid states | Empty or invalid requests remain visible as bounded safe text | JSDoc / @summary on new helpers or component methods | Unit test plus local render smoke |
| Request validation/projection | neomjs/neo#13018 safe transcript constraint | Projects accepted request text into transcript/evidence state without unsafe HTML | Reject overlong or malformed request state | JSDoc / @summary | Unit tests for valid, empty, overlong, and HTML-like input |
| First-widget intent bridge | neomjs/neo#13353 blueprint contract | Accepted request selects the existing constrained first-widget blueprint path | If prerequisite blueprint contract is absent, show a bounded unavailable state | JSDoc / @summary | Unit test proving no duplicate widget path is introduced |
...
Blocked by neomjs/neo#13355.
Prerequisite chain: neomjs/neo#13355 depends on neomjs/neo#13353 / PR neomjs/neo#13354.
...
Live latest-open sweep: checked the latest 20 open issues immediately before creation on 2026-06-15T15:29:10Z. Relevant results were neomjs/neo#13349, neomjs/neo#13355, neomjs/neo#13353, neomjs/neo#13287, neomjs/neo#13350, neomjs/neo-agent-brain#144, neomjs/neo#13033-adjacent Fleet Manager/Electron items, and unrelated backlog issues; no equivalent chat-intake child leaf was present.
...
> ● [premise correction] The prerequisite chain should now be read as neomjs/neo#13362 -> neomjs/neo#13355 -> neomjs/neo#13357.
> 
> Verified live on 2026-06-15: neomjs/neo#13353 / PR neomjs/neo#13354 are closed, and neomjs/neo#13362 / PR neomjs/neo#13363 supersede them with the Neural-Link-created-grid proof. Keep neomjs/neo#13357 blocked by neomjs/neo#13355, but do not route accepted request intent into the rejected static-blueprint path. The intake slice should feed the corrected NL-created-grid / live-app proof after neomjs/neo#13355 updates its evidence surface.
