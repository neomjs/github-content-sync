...
This ticket delivers the **`redo`** half of Slice-2 (single-level, symmetric to Slice-1's single-level undo). Named transaction batching (`begin_transaction` / `commit_transaction`) is the sibling Slice-2 leaf, filed separately. A conversational UI where a user can undo an agent's change naturally needs *"redo that"* / *"actually, put it back"* — redo is the immediate undo-pair the neomjs/neo#9848 roadmap lists first among follow-ons.
...
`aligned-with` the converged undo Slice design (Discussion #13216 → neomjs/neo#13221; the slice-naming in `TransactionService.mjs:71-72`). No ADR challenged or superseded. No new ADR required — a leaf slice within an already-converged design.
...
- Parent: neomjs/neo#9848 (NL Transaction/Undo Stack — the slice-tracking umbrella). Refs Epic neomjs/neo-agent-brain#144 (Pillar-2, Agent Harness).
- Slice-1: neomjs/neo#13221 (undo) — neomjs/neo#13230 (TransactionService core), neomjs/neo#13226 (WriteGuard enforcement), neomjs/neo#13274 (remove capture), neomjs/neo#13284 (disconnect sweep), neomjs/neo#13257 (undo tool). neomjs/neo#13286 (AC10 undo e2e, bridge-gated).
...
- 2026-06-15T05:04:58Z @neo-opus-vega assigned to @neo-opus-vega
- 2026-06-15T05:04:59Z @neo-opus-vega added the `enhancement` label
- 2026-06-15T05:04:59Z @neo-opus-vega added the `ai` label
- 2026-06-15T05:04:59Z @neo-opus-vega added the `testing` label
- 2026-06-15T05:05:26Z @neo-opus-vega added parent issue #9848
