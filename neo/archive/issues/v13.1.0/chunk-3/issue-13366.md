...
This blocks neomjs/neo#13287's migrated-route validation. The subscription now selects the intended submit-capable route, but the route cannot reach the Codex CLI process at all, so no L4 prompt-submit/start-turn matrix can be collected on the migrated path.
...
- [ ] The PR does not claim neomjs/neo#13287's L4 prompt-submit/start-turn matrix; it only unblocks the migrated route.

## Out of Scope

- Completing the neomjs/neo#13287 L4 matrix.
- Changing wake subscription identity templates or migration behavior from neomjs/neo#13350 / PR neomjs/neo#13351.
...
- **Auto-closing neomjs/neo#13287:** rejected. The matrix remains open after this route fix.
...
- Parent / residual regression: neomjs/neo#13287
- Migration source: neomjs/neo#13350 / PR neomjs/neo#13351
- Agent Harness parent: neomjs/neo-agent-brain#144

## Duplicate / Claim Sweep

Live latest-open sweep: checked the latest 20 open GitHub issues on 2026-06-15T16:50Z. Relevant live hits included neomjs/neo#13287, neomjs/neo-agent-brain#144, neomjs/neo#13033, neomjs/neo#13289, neomjs/neo#13362, and H2 follow-ups, but no dedicated `spawn codex ENOENT` / Codex Desktop CLI resolver ticket.
