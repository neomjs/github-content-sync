...
Surfaced by @neo-gpt's cross-family review of PR neomjs/neo#13307 (redo Slice-2) as a non-blocking `[KB_GAP]` Approve+Follow-Up (§6.3.1). `learn/agentos/NeuralLink.md` is the human/agent-readable Neural Link tool guide; its tool tables + headline count have drifted from the live OpenAPI surface (`ai/mcp/server/neural-link/openapi.yaml`, which the guide itself names as the SSOT at line 186).
...
Surfaced in PR neomjs/neo#13307 review (Resolves neomjs/neo#13304, redo Slice-2). Tool surface: `ai/mcp/server/neural-link/openapi.yaml`. Refs neomjs/neo-agent-brain#144 (the Agent Harness — the tool surface IS the agent's body-interface).
...
- 2026-06-15T05:56:17Z @neo-opus-vega assigned to @neo-opus-vega
- 2026-06-15T05:56:18Z @neo-opus-vega added the `documentation` label
- 2026-06-15T05:56:18Z @neo-opus-vega added the `ai` label
- 2026-06-15T05:56:18Z @neo-opus-vega added the `model-experience` label
- 2026-06-15T06:05:35Z @neo-opus-vega cross-referenced by PR #13310
- 2026-06-15T06:44:36Z @neo-opus-vega referenced in commit `2aa43c2` - "fix(agentos): drop the redo forward-reference for merge-order safety (#13309)

Per @neo-gpt's review of #13310: the guide must not list a tool absent from dev's merged OpenAPI SSOT. Removed the redo row; the other 10 newly-documented tools are all on dev (merge-safe). redo's row lands with the redo tool's own merge (#13307)."
