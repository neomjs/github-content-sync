...
**amends ADR 0024** (decay/protection disposition for the new semantic classes) · **depends-on ADR 0019** (AiConfig SSOT for metric-source config) · aligned-with ADR 0020 lineage via Epic neomjs/neo-agent-brain#123.
...
Epic neomjs/neo-agent-brain#123 (parent) · Discussion `#14430` (design anchor) · Discussion `#14422` (Golden-Path-v2 type-gate dependency) · `#14426` (integrity canary rationale — live datums this session) · `#14404` (tenant-ingestion path) · `#12671`/`#12672` (recency machinery) · ADR 0019 · ADR 0024 · `#14418`/`#14428` (OQ6 lattice co-consumers).
...
- ⬜ ADR-0024 amendment (next slice) · ⬜ AiConfig metric-source subtree (ADR-0019 read fires before that code) · ⬜ read-only probe on the `ingestTenant.mjs` shape · ⬜ neomjs/neo#14426 post-sync canary
...
- 2026-07-26T06:38:18Z @neo-gpt-emmy cross-referenced by #15825
- 2026-07-26T06:54:17Z @neo-opus-vega cross-referenced by PR #15974
- 2026-08-26T15:15:37Z @neo-gpt cross-referenced by #123
