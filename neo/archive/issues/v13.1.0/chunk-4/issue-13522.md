...
This is the closeable implementation leaf for the unclaimed-review-queue escalation now recorded on neomjs/neo#10777. neomjs/neo#10777 remains the broad historical / current source-of-authority family for agent-runtime engagement discipline; it is too broad to close honestly from one PR. This ticket extracts the review-request liveness slice so a PR can `Resolves` a narrow target.

Live evidence from `2026-06-19T05:39Z`:

| PR | Author | Created | State | Reviewer | Reviews |
|---|---|---|---|---|---|
| neomjs/neo#13500 | `neo-gpt` | `2026-06-19T01:59Z` | CLEAN / green | `neo-opus-vega` | `[]` |
| neomjs/neo#13502 | `neo-gpt` | `2026-06-19T02:29Z` | CLEAN / green | `neo-opus-ada` | `[]` |
| neomjs/neo#13504 | `neo-gpt` | `2026-06-19T03:02Z` | CLEAN / green | `neo-opus-ada` | `[]` |
| neomjs/neo#13507 | `neo-gpt` | `2026-06-19T03:44Z` | CLEAN / green | `neo-opus-grace` | `[]` |
| neomjs/neo#13509 | `neo-gpt` | `2026-06-19T04:18Z` | CLEAN / green | `neo-opus-vega` | `[]` |
...
Live latest-open sweep: checked latest 20 open issues at `2026-06-19T05:40Z`; no equivalent closeable leaf found. neomjs/neo#10777 is the broad parent/family and already carries the AC, but not a narrow close target.

A2A in-flight sweep: checked latest 30 all-status messages at `2026-06-19T05:41Z`; found existing pings and neomjs/neo#10777 updates, no competing leaf claim or filed duplicate.
...
- neomjs/neo#10777 is the current broad source-of-authority issue for runtime engagement discipline and already contains the unclaimed-review-queue escalation AC.
...
|---|---|---|---|---|---|
| Author-side review routing | `pull-request-workflow.md §6.2`, `ci-green-review-routing.md`, neomjs/neo#10777 | After initial reviewer assignment, stale green review-requested own PRs become coordination/backpressure, not permission to pile more same-reviewer PRs | If the reviewer is cold/unreachable, route to handoff / third reviewer / liveness substrate rather than broadcast into a void | Existing PR routing docs | Live neomjs/neo#13500/#13502/#13504/#13507/#13509 matrix |
...
| Authorship concentration / reviewer scarcity frame | `author-concentration-detector.md`, neomjs/neo#12440, neomjs/neo#10777 | Treat green PR pile-up as liveness telemetry; surface/rebalance, never throttle productive authors by quota | Non-PR work remains first-class; no contribution counter or fairness band | Existing detector payload | neomjs/neo#10777 fresh empirical anchors |
| A2A recovery template | A2A message protocol, neomjs/neo#10777 | Provide a compact claim/decline/handoff/blocker template for stale routed reviews | Actionable pings must wake; ordinary observer notes may still be suppressed | Existing `add_message` wake-control rules | 04:35Z and 05:40Z direct pings |
...
- Closing neomjs/neo#10777.
- Building the mechanical lane-ownership / wake-decision ledger from neomjs/neo#12612 / neomjs/neo#12633.
...
- Parent/family: neomjs/neo#10777
- Liveness-first authorship frame: neomjs/neo#12440
- Wake-driver substrate: neomjs/neo-agent-brain#148
- Successor mechanical lanes: neomjs/neo#12612, neomjs/neo#12633
- Live evidence PRs: neomjs/neo#13500, neomjs/neo#13502, neomjs/neo#13504, neomjs/neo#13507, neomjs/neo#13509

Origin Session ID: 22d7a821-c417-459f-9308-7216c920ecb0

Retrieval Hint: "review-request liveness active-window claim decline handoff neomjs/neo#10777 neomjs/neo#13500 neomjs/neo#13502 neomjs/neo#13504 neomjs/neo#13507 neomjs/neo#13509"


## Timeline

- 2026-06-19T05:45:05Z @neo-gpt assigned to @neo-gpt
- 2026-06-19T05:45:06Z @neo-gpt added the `enhancement` label
- 2026-06-19T05:45:06Z @neo-gpt added the `ai` label
- 2026-06-19T05:45:06Z @neo-gpt added the `architecture` label
- 2026-06-19T05:45:06Z @neo-gpt added the `model-experience` label
...
Correction from @tobiu on neomjs/neo#13562 review: the primary-reviewer hard silence timeout for the Neo agent team is **4h max**, not the stale 24h wording preserved in this ticket.
...
PR neomjs/neo#13562 head `754e432ff` now implements the 4h max wording in `pull-request-workflow.md` and the PR body has been updated to make this correction explicit.
