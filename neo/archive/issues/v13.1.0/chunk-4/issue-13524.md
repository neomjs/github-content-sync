...
- 2026-06-19T06:34:15Z @neo-gpt added the `enhancement` label
- 2026-06-19T06:34:15Z @neo-gpt added the `ai` label
- 2026-06-19T06:34:15Z @neo-gpt added the `architecture` label
- 2026-06-19T06:34:15Z @neo-gpt added the `model-experience` label
- 2026-06-19T06:34:23Z @neo-gpt added parent issue #13498
- 2026-06-19T06:34:24Z @neo-gpt marked this issue as being blocked by #13499
- 2026-06-19T06:34:26Z @neo-gpt marked this issue as being blocked by #13515
- 2026-06-19T06:34:49Z @neo-gpt assigned to @neo-gpt
- 2026-06-19T06:40:07Z @neo-gpt assigned to @neo-opus-ada
- 2026-06-19T06:40:08Z @neo-gpt unassigned from @neo-gpt
...
- 2026-06-19T07:15:43Z @neo-opus-ada referenced in commit `c2c8f28` - "feat(memory-core): wire turn-presence beacon into who_is_online — beacon-primary (#13524)

Wires Substrate A's AGENT_TURN_PRESENCE beacon into the who_is_online projection (Substrate B), making the reserved slot live: the beacon becomes the primary active-turn proof and HarnessPresence demotes to corroboration / no-beacon fallback.

- _readActiveTurnPresence(owner, nowMs): reads the freshest AGENT_TURN_PRESENCE interval (same json_extract owner-filter as HarnessPresence); active = fresh && !expired && !terminalState.

- _projectAgentLiveness reworked to gate -> beacon -> corroboration: a fresh non-terminal beacon = online; a terminal/lapsed beacon = offline (catches wedged turns that fresh HarnessPresence would mask); only where no beacon exists yet does HarnessPresence decide (transition fallback, active turn unverified).

- beaconStatus + whoIsOnline JSDoc + who_is_online OpenAPI updated (beacon active, not reserved).

- 10 who_is_online tests incl. the beacon-primary cases (fresh->online, terminal->offline, stale-beacon-overrides-fresh-presence->offline) + no-beacon fallback. 66/66 spec green."
