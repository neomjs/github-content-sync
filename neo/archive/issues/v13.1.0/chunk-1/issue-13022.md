...
Operator design direction on Epic neomjs/neo-agent-brain#144 made the harness UI quality bar explicit: one peer should own the visual/design focus, and the harness must support the portal theme pair (`neo-theme-neo-dark` + `neo-theme-neo-light`) from day one rather than treating theming as polish after functionality lands. A later neomjs/neo-agent-brain#144 strategy update sharpened the product frame: Claude-Desktop-style parity is the floor; the category bet is the flat-peer, cross-family institution getting a face. The visual system is therefore not decoration — it is part of the product proof.
...
- Epic neomjs/neo-agent-brain#144 owns the harness product shape. Board 13 is the live work-state surface; neomjs/neo#13020 owns ADR 0020 as the cold-read concept anchor; neomjs/neo#13018 owns the Markdown VDOM component, not the harness visual system.
...
`depends-on neomjs/neo#13020` for the cold-read Agent Harness concept anchor, and `aligned-with ADR 0018` for Neo's identity framing: the harness is the Institution getting a user-facing Body, not a generic chat wrapper. No accepted ADR conflict identified.
...
- [ ] The PR body states which roadmap horizon(s) it serves from neomjs/neo-agent-brain#144, with H2 `Your-first-agent-beautifully` as the default unless the implemented slice proves a stronger horizon mapping.
...
Parent: Epic neomjs/neo-agent-brain#144. Live board: Project 13. Concept anchor: neomjs/neo#13020. Fleet Manager epic: neomjs/neo#13015. Markdown VDOM sibling: neomjs/neo#13018.
...
- Live latest-open sweep: checked latest 20 open issues at 2026-06-12T21:28:52Z; neomjs/neo-agent-brain#144/#13020/#13018 exist, no concrete harness visual-system/theme leaf found.
- A2A in-flight sweep: checked latest 30 messages immediately before filing; found my own `[lane-intent]`, neomjs/neo#13018 parser progress, neomjs/neo-agent-brain#144 strategy update, and no competing concrete visual-system leaf.
...
- 2026-06-12T22:44:30Z @tobiu referenced in commit `a81b732` - "feat(agentos): seed harness visual system (#13022) (#13024)"
- 2026-06-12T22:44:30Z @tobiu closed this issue
