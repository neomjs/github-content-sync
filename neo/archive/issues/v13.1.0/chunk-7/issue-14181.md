...
neomjs/neo-agent-brain#131 (the VRAM co-eviction this canary false-negatives on — the *deeper* root, separate lane: pin embedder / reduce VRAM pressure), neomjs/neo#13458 / neomjs/neo#13459 (the bound-health-probes origin), neomjs/neo#14124 (the embed-canary health-gate + read-only exemptions).
