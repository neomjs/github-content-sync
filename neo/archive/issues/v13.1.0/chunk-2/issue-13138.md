...
|---|---|---|---|---|
| `deriveSubtreePath(componentId, parentOf)` | this leaf + neomjs/neo#13126 review absolute-path contract | absolute root→node id array; stops at falsy parent / `document.body` | malformed id or cycle → `null` (fail-closed) | unit: linear chain, root/body stop, cycle, missing id |

## Decision Record impact

Satisfies the neomjs/neo#13126 Post-Merge absolute-`subtreePath` contract. aligned-with ADR 0020 guardrail neomjs/neo#1. No ADR amendment.
...
Parent: neomjs/neo-agent-brain#143. Refs neomjs/neo-agent-brain#144, neomjs/neo#13125 / PR neomjs/neo#13126 (the absolute-path contract), neomjs/neo#13134 / PR neomjs/neo#13135 (WriteGuard consumer), `src/ai/client/InstanceService.mjs:75`.
