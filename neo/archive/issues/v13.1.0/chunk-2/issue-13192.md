...
`none` — aligned-with the neomjs/neo#13015 MVP decomposition + neomjs/neo#13167's control-plane framing; composes merged primitives without modifying them.
...
- The agent-removal flow + its neomjs/neo-agent-brain#142 memory reconciliation (separate lifecycle leaf).

## Related

- Parent epic neomjs/neo#13015 (FM MVP). The control-plane service layer over neomjs/neo#13178 (`startAgentProvisioned`) + neomjs/neo#13180 (`inspectFleetRepos`); neomjs/neo#13167 control-plane framing; surface (piece 3) routed to @neo-gpt.
