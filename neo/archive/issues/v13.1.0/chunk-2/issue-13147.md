...
The QT-grade docking line under neomjs/neo#13030 has now moved through the narrow contract and rendering leaves:

- neomjs/neo#13061 / PR neomjs/neo#13062 closed the dock-zone model contract.
- neomjs/neo#13086 / PR neomjs/neo#13087 closed the drag-to-dock preview-state contract.
- neomjs/neo#13089 / PR neomjs/neo#13090 closed the split/tab adapter boundary.
- neomjs/neo#13104 / PR neomjs/neo#13109 closed the visual preview renderer.
- neomjs/neo#13105 / PR neomjs/neo#13107 closed split/tab layout rendering.
- neomjs/neo#13115 / PR neomjs/neo#13116 closed semantic dock-zone operations.
- neomjs/neo#13120 / PR neomjs/neo#13142 relocated the reusable dock-zone subsystem under `src/`.
- neomjs/neo#13127 / PR neomjs/neo#13128 closed the saved-layout persistence boundary, but explicitly kept save/restore code out of scope.

neomjs/neo#13030 still carries the scoping-level AC that layouts are serializable/restorable and blueprint-compatible. The remaining gap is not another contract note; it is a tiny runtime helper surface that turns the existing normalized `neo.harness.dockZone.v1` document into a saved layout wrapper and restores it fail-closed.
...
| Storage boundary | ADR 0020 + neomjs/neo#13030/#13127 | No storage backend, UI, or user preference API in this ticket | Later app-local storage leaf consumes these helpers | same | Diff contains only executor/spec/doc touchpoints |
...
- **Generic core lift** — rejected; neomjs/neo#13120 relocated reusable dock-zone model pieces, but first save/restore ownership remains harness-local until another consumer proves generic need.

## Related

Parent: neomjs/neo#13030
Parent epic: neomjs/neo-agent-brain#144
Refs neomjs/neo#13127
Refs neomjs/neo#13120
Refs neomjs/neo#13115
Refs neomjs/neo#13105

Live latest-open sweep: checked latest 20 open issues at 2026-06-14T00:00+02:00; no equivalent runtime dock layout persistence ticket found. Closest live issue is neomjs/neo#13030, the scoping anchor.
...
Retrieval Hint: "dock layout persistence runtime saved layout wrapper DockZoneModel createSavedLayout restoreSavedLayout neomjs/neo#13030"
