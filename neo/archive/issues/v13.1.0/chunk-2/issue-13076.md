...
Parent: neomjs/neo#13032 · Epic: neomjs/neo-agent-brain#144

The reusable **measurement & comparison machinery** for the Harness Endurance Benchmark — the falsifier scaffold neomjs/neo#13032 needs before it can render a calibrated verdict. Split out from neomjs/neo#13032 so the machinery can land now while neomjs/neo#13032 stays open for the load-calibration → conclusive verdict → published numbers it still tracks.
...
## Out of scope (remains on neomjs/neo#13032)
...
Delivered by PR neomjs/neo#13066.
