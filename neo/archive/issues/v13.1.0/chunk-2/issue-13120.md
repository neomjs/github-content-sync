...
Operator direction (2026-06-13, reviewing PR neomjs/neo#13116): *"dock zones sounds more like a neo layout topic, and should be available to other apps => src folder."* This is the out-of-scope follow-up to the docking-line PRs, and it resolves the placement-coherence question the line surfaced.
...
- model: `AgentOS.dock.DockZoneModel` in `apps/agentos/dock/` (PR neomjs/neo#13116, neomjs/neo#13115)
- adapter: `Neo.dashboard.DockLayoutAdapter` in `src/dashboard/` (PR neomjs/neo#13107, neomjs/neo#13105)

Root cause: `learn/agentos/HarnessDockZoneModel.md` is **internally inconsistent on ownership** — the decision-tree (line ~35) says *"place the adapter in the harness app layer"*, while the Split/Tab Adapter Boundary (line ~289) says *"ownership starts in the Agent Harness / dashboard layer."* The two PRs each followed a different line, producing the split. @neo-opus-vega's neomjs/neo#13107 RA1 flagged the adapter placement specifically.
...
- [ ] Resolves @neo-opus-vega's neomjs/neo#13107 RA1 placement concern (cite this ticket in neomjs/neo#13107).
...
Do **after** PR neomjs/neo#13116 (model) and PR neomjs/neo#13107 (adapter) merge — relocating before they land would churn open PRs. Until then this stays parked.

## Related

Parent: neomjs/neo#13030. Refs neomjs/neo-agent-brain#144, neomjs/neo#13115, neomjs/neo#13116, neomjs/neo#13105, neomjs/neo#13107. Source of authority: `learn/agentos/HarnessDockZoneModel.md`.
