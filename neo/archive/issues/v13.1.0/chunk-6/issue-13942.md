...
Release classification: deployment-recovery hardening under neomjs/neo#13874; boardless unless the operator promotes it to a deployment-readiness gate.

Live latest-open sweep: checked latest 20 open issues at 2026-06-24T08:51:14Z. Related but non-equivalent tickets: neomjs/neo#13874 (recovery daemon epic), neomjs/neo#13914 (read-only deployment observability MCP tool), neomjs/neo-agent-brain#134 (live deployment closeout smoke), neomjs/neo#13852 (local-dev native-Ollama serve/context lifecycle), neomjs/neo#13700 (LM Studio parallel/cache issue). A2A in-flight sweep over latest 30 messages at 2026-06-24T08:51:14Z returned 0 messages.
...
4. Re-observe after action and record the outcome in the recovery-run ledger. The public proof path remains neomjs/neo#13914/#13936; this ticket owns the daemon decision/action seam.
...
| Public proof surface | neomjs/neo#13914 + neomjs/neo-agent-brain#134 | Recovery-runs and diagnosis outcomes become visible through approved public KB/MC read surfaces | If graph is unavailable, direct deployment-state bridge/tool reports explicit stale/missing state | Tool schema / smoke transcript | L3 deployment smoke |
...
- [ ] neomjs/neo#13914/#13936 can use the resulting diagnosis/recovery-run evidence in the deployment smoke path.
...
- Re-opening the closed Ollama readiness/reporting slice neomjs/neo#13879.
- Replacing the narrow LM Studio fix in neomjs/neo#13941.
...
Parent: neomjs/neo#13874. Depends on diagnostics substrate from neomjs/neo#13860 / ADR-0025 and recovery substrate from ADR-0026. Related: neomjs/neo#13700, neomjs/neo#13941, neomjs/neo#13852, neomjs/neo#13879, neomjs/neo#13914, neomjs/neo-agent-brain#134, #13873.
