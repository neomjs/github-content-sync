...
- Live latest-open sweep before creation: neomjs/neo#13994, neomjs/neo#13983, neomjs/neo-agent-brain#134, and older design-gated backlog; no open LMS developer-log flood ticket.
...
- KB sweep did not know a current `LMSAuthenticator` ticket; related history exists around `/v1/models` readiness/request storms, especially archived neomjs/neo#12262 and current neomjs/neo#13950, but neither covers this exact regression.
...
- Reopening neomjs/neo#13995 or neomjs/neo#13996.
- Changing LM Studio/LMS server logging behavior.
- Hiding real provider failures from diagnostics or recovery daemons.
- Solving unrelated REM token-accounting anomalies from neomjs/neo#13994.
...
- Follow-up to insufficient neomjs/neo#13995 / neomjs/neo#13996 outcome.
- Related historical precedent: neomjs/neo#12262 reduced a prior per-poll probe/log storm.
- Nearby model-list readiness concern: neomjs/neo#13950.
