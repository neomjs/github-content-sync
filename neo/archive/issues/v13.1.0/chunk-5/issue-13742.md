...
Live latest-open sweep: checked the latest 20 open issues on 2026-06-21; found neomjs/neo#13740 (`Stop-hook hold-costume tripwire`) but no equivalent ticket for extracting the neomjs/neo#13726 deference decision into a shared hook decision surface. Exact live search for `deferencePhraseMatch` / `stopHookDecision` found neomjs/neo#13740, neomjs/neo#13679, neomjs/neo#13731, and neomjs/neo-agent-brain#137; none covers this shared-decision extraction. A2A recency sweep: latest 30 messages showed no competing claim for this scope.
...
- `ai/scripts/lifecycle/deferencePhraseMatch.mjs` now owns phrase matching and reminder text after PR neomjs/neo#13726.
...
Aligned with neomjs/neo-agent-brain#137, neomjs/neo#13674, and the merged neomjs/neo#13726 hook parity work. No ADR change required.
...
- [ ] No new broad phrase patterns are introduced; neomjs/neo#13740 remains the separate hold-costume lexicon lane.
...
- Reopening neomjs/neo#13674 or changing neomjs/neo#13726 merge eligibility.
...
- Do not conflate this with neomjs/neo#13740. That ticket is about detecting another lexicon; this one is about preventing duplicated business logic for the already-merged deference register.

## Related

Related: neomjs/neo-agent-brain#137
Related: neomjs/neo#13674
Related: neomjs/neo#13740
Related: PR neomjs/neo#13726
