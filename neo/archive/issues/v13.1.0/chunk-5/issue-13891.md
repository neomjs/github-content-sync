...
|---|---|---|---|---|---|
| `add_message` acknowledgment boundary | Parent epic neomjs/neo#13889 and `MemoryService.addMemory()` WAL-first precedent | Return success only after durable message WAL append, or fail before ack | Validation errors remain fail-loud and non-accepted | JSDoc / PR body | L2 unit tests for ack ordering |
...
- Local/cloud drain topology; that is neomjs/neo#13890.
...
Related: neomjs/neo#13890, neomjs/neo-agent-brain#157
