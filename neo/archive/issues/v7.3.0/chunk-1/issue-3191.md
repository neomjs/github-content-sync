...
## Proposal
The  Conventional Commits specification [QUARANTINED_URL: conventionalcommits.org] is a widely known and accepted specification for structuring commit messages, effectively allowing to tag commits with a type, a scope and the commit's intend:
...
It dovetails with SemVer [QUARANTINED_URL: semver.org] which the project already uses for identifying release versions of the software.
