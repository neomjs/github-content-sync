...
- I wanted to use Keycloak.js  [QUARANTINED_URL: npmjs.com] API. The official JS implementation of Keylcloak. It requires `windows` object to setup an iFrame which redirects users to the login page.
