...
**Additional context**
React documentation has a page dedicated to understanding the codebase here [QUARANTINED_URL: reactjs.org]. It explains where to find what you need.
...
Hey @tobiu, I created an initial draft for some documentation [QUARANTINED_URL: github.com]. Would be great if you could provide some comments. 
