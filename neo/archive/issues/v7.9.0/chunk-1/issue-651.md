...
**Describe the bug**
The demo application ([QUARANTINED_URL: neomjs.github.io]) does not load when uBlock Origin browser extension is enabled in Chrome.
...
2. Load demo app ([QUARANTINED_URL: neomjs.github.io])
...
!Screenshot 2020-05-28 at 10 01 30 [QUARANTINED_URL: user-images.githubusercontent.com]
...
Refs: [QUARANTINED_URL: github.com]
