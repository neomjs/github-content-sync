...
```
git clone [QUARANTINED_URL: github.com]
mv neo neo-7.0.6
cd neo-7.0.6
npm i
npm run build all
...
!examples-todoList-version2-start [QUARANTINED_URL: github.com]

2. click on first item check box
!examples-todoList-version2-clicked-first-item [QUARANTINED_URL: github.com]


3. edit cls to add neo-selected => checkmark appears
!examples-todoList-version2-edit-add-neo-selected [QUARANTINED_URL: github.com]
