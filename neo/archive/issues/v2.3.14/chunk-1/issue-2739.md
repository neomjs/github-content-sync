...
Was looking at trying this UI framework for a new app, and I'm trying to view some of the samples. Some work, but trying to navigate to "[QUARANTINED_URL: localhost:8080]" yields, in the console:
...
Navigated to [QUARANTINED_URL: localhost:8080]
```
...
7.21.1
dave@dave-macbook-pro failing-js % git clone -b main [QUARANTINED_URL: github.com]
Cloning into 'neo'...
...
<i> [webpack-dev-server] Loopback: [QUARANTINED_URL: localhost:8080]
<i> [webpack-dev-server] On Your Network (IPv4): [QUARANTINED_URL: 192.168.1.159:8080]
...
...then navigating to [QUARANTINED_URL: localhost:8080] yields the above error.
