...
## Test Evidence
- `git diff --check`
- `rg -n "active neomjs/neo#11720|still owned|Known Gaps|adds KB/MC|extends the proof" learn/agentos/DeploymentCookbook.md learn/agentos/cloud-deployment/Security.md` — no matches.
...
- [ ] Confirm neomjs/neo#11736 auto-closes and neomjs/neo#11730 remains open as the post-MVP residual parent.
