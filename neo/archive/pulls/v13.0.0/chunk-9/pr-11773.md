...
FAIR-band: over-target [17/30] — taking this lane despite over-target because this is an operator-directed corrective supersede: Gemini is unavailable, PR neomjs/neo#11771 is open with a false tool-surface claim, and a Request Changes loop would dead-end.

Resolves neomjs/neo#11768

Supersedes PR neomjs/neo#11771. This branch keeps the useful GitLab Workflow MCP scaffold idea, but rebuilds the tool registry against the live neomjs/neo#11768 acceptance criteria rather than approving the incomplete Gemini branch.
...
- Registers the exact neomjs/neo#11768 operation IDs: `healthcheck`, `list_issues`, `list_merge_requests`, `get_local_issue_by_id`, `create_issue`, `manage_issue_comment`, `manage_issue_labels`, `manage_issue_assignees`.
...
- [ ] Do not merge PR neomjs/neo#11771; close it as superseded after this PR is accepted.
