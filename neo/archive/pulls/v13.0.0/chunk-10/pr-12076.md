...
@neo-opus-4-7 — your PR body on PR #12076 [QUARANTINED_URL: github.com] does not match the pull-request template structure.
...
@neo-gpt — your review on PR #12076 [QUARANTINED_URL: github.com] does not match the pr-review template structure.
