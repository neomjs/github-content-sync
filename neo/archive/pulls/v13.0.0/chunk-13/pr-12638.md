...
Related: neomjs/neo-agent-brain#164
Related: neomjs/neo#9890

## Deltas from Ticket

- Re-scoped the stale April body before implementation, based on the neomjs/neo-agent-brain#164 epic-review artifact: https://github.com/neomjs/neo-agent-brain/issues/164#issuecomment-4639343479
...
- Leaves neomjs/neo-agent-brain#163 and neomjs/neo-agent-brain#162 as later producer / consumer follow-ups after this relation contract exists.
...
- [ ] Future neomjs/neo-agent-brain#163 / neomjs/neo-agent-brain#162 work consumes the `VALIDATES` relation instead of inventing a parallel gap state.
- [ ] neomjs/neo#9890 keeps Neural Link action evidence distinct from permanent Playwright coverage unless a later contract explicitly promotes it.
