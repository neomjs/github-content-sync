...
- Preserves neomjs/neo#13458's "bound health probes" intent — 30s is still a bound (a genuinely-hung embedder fails at 30s), not a removal. Only the value overshot the real cold-load latency.
...
neomjs/neo-agent-brain#131 (the VRAM co-eviction this false-negatives on — the deeper root, separate lane: pin embedder / reduce VRAM pressure), neomjs/neo#13458 / neomjs/neo#13459 (the bound-health-probes origin), neomjs/neo#14124 (the embed-canary gate + read-only exemptions).
