...
neomjs/neo-agent-brain#131 (the fire — this makes its 404 diagnosable, distinct from root-causing it via the runtime discriminator); neomjs/neo#14124 (the embed-canary catch-22).
