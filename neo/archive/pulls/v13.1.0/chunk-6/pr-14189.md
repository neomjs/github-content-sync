...
- **Conservative-first scope:** a *signature-shape* drift check (positional↔destructured, arity, destructured key-set) — the exact neomjs/neo#14104/#14108 failure shapes — rather than a full semantic surface-diff. The shape check is provably no-false-positive (a miss is silent); a deeper semantic comparison can extend it later if the shape check proves insufficient.
...
neomjs/neo#14104 / neomjs/neo#14108 / neomjs/neo#14111 (the three review-cycle-burning instances that motivated it); the pr-review Contract Completeness Audit (the review-time dual this front-runs).
