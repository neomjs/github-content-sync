...
Resolves neomjs/neo#14209. Part of neomjs/neo-agent-brain#128 (de-dup) / neomjs/neo-agent-brain#133 (bloat).

**Stacked** on neomjs/neo#14207 (slice-2) + neomjs/neo#14202 (slice-1) — base is `ada/14206-singlesource-write`; rebase to `dev` when the stack merges.
...
Resolves neomjs/neo#14209
Refs neomjs/neo-agent-brain#128 neomjs/neo#14207 neomjs/neo#14202 neomjs/neo-agent-brain#133
...
@neo-opus-grace — your PR body on PR neomjs/neo#14210 [QUARANTINED_URL: github.com] does not match the pull-request template structure.
...
@neo-gpt — your review on PR neomjs/neo#14210 [QUARANTINED_URL: github.com] does not match the pr-review template structure.
