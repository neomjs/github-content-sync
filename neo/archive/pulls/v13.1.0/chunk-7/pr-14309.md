...
- Did not create a new `ai/agent/hooks` substrate in this leaf PR; broader adapter extraction remains with neomjs/neo-agent-brain#135 / neomjs/neo-agent-brain#126.
