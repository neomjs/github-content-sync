...
contentTrust:
  ...
  signals: []
---
Resolves neomjs/neo#13914

Related: neomjs/neo#13860
...
Evidence: L2 (unit coverage for bridge recovery-run/provider-residency projection plus KB/MC OpenAPI/toolService drift checks) -> L3 required (live cloud smoke through the deployed public KB/MC tool path). Residual: live smoke tracked by neomjs/neo-agent-brain#134.
...
- [ ] Run neomjs/neo-agent-brain#134 against the live cloud deployment through the public KB/MC MCP tool path.
...
Rebased neomjs/neo#13938 onto current `dev` and pushed head `88f508300c`.
