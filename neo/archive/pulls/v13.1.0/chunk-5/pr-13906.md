...
- A2A-message Chroma/search population is deferred to neomjs/neo-agent-brain#157 / later drain work; this topology adds no synchronous chat/embed/model calls to `add_message`.
