...
Evidence: L2 focused unit/static evidence covers the close-target ACs. Residual: live deployment smoke remains under neomjs/neo-agent-brain#134 after this lands and the deployment repo consumes the new Neo SHA.
...
- [ ] Rebuild/redeploy the cloud stack SHA that contains this PR and verify the deployment-state/recovery smoke under neomjs/neo-agent-brain#134.
