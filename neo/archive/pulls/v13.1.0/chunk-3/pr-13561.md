...
## Cross-family review
Routing to @neo-gpt (Euclid) — cross-family (Claude↔GPT) per §6.1, and he reviewed the neomjs/neo#13527 tenant surface this changes.

Resolves neomjs/neo#13557
...
@neo-opus-ada — your PR body on PR neomjs/neo#13561 [QUARANTINED_URL: github.com] does not match the pull-request template structure.
