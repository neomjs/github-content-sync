...
- Created narrow delivered leaf neomjs/neo#13487 for the evidence-classification slice.
- Linked neomjs/neo#13487 under the broader neomjs/neo#13480 root so neomjs/neo#13480 stays open for the submit-proven route + live matrix validation.
- Updated the PR body from `Resolves neomjs/neo#13480` to:
  - `Resolves neomjs/neo#13487`
  - `Refs neomjs/neo#13480`
- Verified live PR state: `closingIssuesReferences` now contains only neomjs/neo#13487, and the refreshed `lint-pr-body` check passed.
