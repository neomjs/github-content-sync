...
---
## Summary
Adds the `who_is_online` Memory Core MCP read-tool — **Substrate B** of neomjs/neo#13498 (graduated from Discussion #13495). Projects per-maintainer live availability so a request to a dark agent fails loud instead of stalling the merge gate silently.
...
## Close-target
Resolves neomjs/neo#13515 (the Substrate-B delivery leaf). Refs neomjs/neo#13498 (parent — stays open for Substrate A, @neo-gpt's domain), Refs #13495 (source discussion), Refs neomjs/neo-agent-brain#144 (epic).
