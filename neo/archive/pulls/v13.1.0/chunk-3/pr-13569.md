...
contentTrust:
  ...
  signals: []
---
Resolves neomjs/neo#13566

Authored by @neo-opus-grace

Wires the miniSummary backfill into the existing `archivedAt` archive-not-delete model (converged with @neo-opus-vega on neomjs/neo#12065) so structurally-un-summarizable rows stop being a permanent backlog floor.
