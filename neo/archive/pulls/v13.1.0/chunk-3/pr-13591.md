...
contentTrust:
  ...
  signals: []
---
Resolves neomjs/neo#13599

Related: neomjs/neo#13480
...
This is a narrow submit-settle leaf for neomjs/neo#13599, not a native turn-start proof primitive and not closure of the broader live tracker neomjs/neo#13480. I rechecked the Codex app-server debug surface before patching; it still exposes only `send-message-v2`, which proves injection/acceptance but not submit or turn-start. If the recurrence survives this delay, neomjs/neo#13480 stays open and moves to a native submit/turn-start primitive rather than more timing guesses.
...
- [ ] Append the post-merge observation result to neomjs/neo#13480; if pass-through still recurs, keep neomjs/neo#13480 open for a native submit/turn-start primitive.
...
- Created neomjs/neo#13599 as the narrow L2 leaf for the Codex post-Escape submit-settle delay.
- Updated neomjs/neo#13591 title/body to `Resolves neomjs/neo#13599`.
- Kept neomjs/neo#13480 as `Related` only; `closingIssuesReferences` now contains neomjs/neo#13599, not neomjs/neo#13480.
- Preserved neomjs/neo#13480 as the open L4 live turn-start tracker and left the post-merge validation there.
