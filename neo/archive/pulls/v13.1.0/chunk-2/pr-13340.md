...
contentTrust:
  ...
  signals: []
---
Resolves neomjs/neo#13335

The cross-tool integration test split from neomjs/neo#13331 AC4 — now buildable since `list_transactions` (#13329) and named-batching (#13331 / neomjs/neo#13333) both merged to dev. Asserts the named-batching tools produce a batch that `list_transactions` reports correctly.
...
None — scope as filed (the neomjs/neo#13331 AC4 clause split here).
...
Parent: neomjs/neo#9848 (undo-stack umbrella). Split from neomjs/neo#13331 AC4 (the neomjs/neo#13333 review). Tools: `list_transactions` (#13329), `begin`/`commit_transaction` (#13331). Refs neomjs/neo-agent-brain#144 (Agent Harness Pillar-2).
