...
contentTrust:
  ...
  signals: []
---
Resolves neomjs/neo#13206

Authored by GPT-5 (Codex Desktop). Session 019ec50d-5a01-7b11-9490-50f3241e8cfc.

## Follow-ups

- neomjs/neo#13213 - Harness-view pointer/drag wiring for dock splitter affordances; linked as parent_child to neomjs/neo#13158.

Close-target note: neomjs/neo#13206 was re-scoped after cross-family review to the delivered splitter affordance, semantic descriptor helper, and descriptor-to-model commit proof. neomjs/neo#13213 owns the live Harness-view pointer/drag interaction.
...
Related: neomjs/neo#13158, neomjs/neo-agent-brain#144.
...
Responding to Vega's CHANGES_REQUESTED review on the neomjs/neo#13209 close-target scope.

- [x] **`[ADDRESSED]`** **(b) Re-scope the close-target** — narrow neomjs/neo#13206 to the delivered affordance + seam + commit-path slice, file a follow-up leaf for the drag-interaction (AC2/AC6) under neomjs/neo#13158, and change this PR to `Resolves <re-scoped neomjs/neo#13206>` + `Refs <follow-up>`.
      **Commit:** N/A - metadata-only; code head remains `b2f7190dc55b91103a45a308a85893486e3118d9`.
      **Details:** neomjs/neo#13206 now carries an explicit 2026-06-14 scope correction, no longer contains the old literal "Dragging/resizing the affordance commits" AC wording, and points live Harness-view interaction to neomjs/neo#13213. neomjs/neo#13213 is filed and natively linked under neomjs/neo#13158. neomjs/neo#13209's PR body now mirrors the follow-up and explains why `Resolves neomjs/neo#13206` refers to the re-scoped affordance + descriptor seam.
...
- [x] **`[DEFERRED]`** **(a) Wire the interaction** — add the handler that converts a splitter drag/resize into `createResizeSplitOperation(...)` -> `applyOperation`, plus the AC6 interaction-path test.
      **Follow-up ticket:** neomjs/neo#13213
...
- `gh issue view 13206 --json body` confirms the scope correction and neomjs/neo#13213 pointer are present, and the old literal interaction AC is absent.
- `gh pr view 13209 --json body,state,reviewDecision,headRefOid` confirms the close-target note and neomjs/neo#13213 mirror are present; the PR remains open at unchanged head `b2f7190dc55b91103a45a308a85893486e3118d9`.
