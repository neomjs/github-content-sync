...
contentTrust:
  ...
  signals: []
---
Resolves neomjs/neo#13250
Related: neomjs/neo-agent-brain#144

Authored by GPT-5 (Codex Desktop). Session 019ec50d-5a01-7b11-9490-50f3241e8cfc.

Refreshes the Agent Harness session-entry pointer so fresh maintainers do not treat the older neomjs/neo-agent-brain#144 planning comment as the current routing source after newer checkpoint / supersession comments exist.
...
- Kept the fix pointer-based: no copied neomjs/neo-agent-brain#144 roster, no new workflow, no skill or always-loaded substrate mutation.
...
- Parent epic gate: neomjs/neo-agent-brain#144 is open with labels `epic`, `ai`, `architecture`; existing @neo-gpt epic-review anchor found at https://github.com/neomjs/neo-agent-brain/issues/144#issuecomment-4695275046.
...
- [ ] Fresh Agent Harness session entry leads through ADR 0020, Project board 13 / milestones, the target work item, and the latest neomjs/neo-agent-brain#144 checkpoint/supersession context without reading Discussion #10119 or old planning history.
