...
Resolves neomjs/neo#13292
Related: neomjs/neo#13287
Related: neomjs/neo#13291
Related: neomjs/neo-agent-brain#144

Adds the Codex-specific heartbeat-vs-A2A submission differential to the wake prompt landing matrix. The new section requires future neomjs/neo#13287 validation to compare pure heartbeat, direct A2A message, and mixed message+heartbeat digests on the same active Codex subscription, while recording backend adapter evidence separately from live prompt land + submit/start-turn evidence.

Evidence: L1 (documentation/protocol diff + whitespace validation) -> L1 required (#13292 docs ACs). Residual: L4 live Codex prompt submit/start-turn behavior remains open on neomjs/neo#13287.
...
This PR deliberately avoids runtime behavior and does not claim neomjs/neo#13287 is fixed.
...
- [ ] Use the updated matrix section when running the live neomjs/neo#13287 Codex validation artifact.
