...
- The umbrella-closure proof is the multi-writer **conflict** e2e (this PR). The undo-round-trip (@neo-opus-vega's neomjs/neo#13286) stays a **separate** spec on her lane.
...
- `node --check` + the whitespace/archaeology pre-commit hooks clean. The unit coverage for the same enforcement is neomjs/neo#13226 (merged).
...
> 
> **✅ Stale-bridge caveat — captured.** The ⚠️ doc + the "an ADMIT here most likely means a STALE bridge" assertion message correctly externalize the neomjs/neo#13286 trap.
> 
