...
The fix is **subtractive** (the additive prose-only attempt, ticket neomjs/neo#12632, was closed-insufficient — "prose alone fails"): remove the enumeration, replace with a hard *"there is ALWAYS more to do — never idle out."* **Net-reduction: 891 → 801 chars (−90)** — closing the loophole by removing prose, not adding a gate.

Resolves neomjs/neo#13195.
Refs neomjs/neo-agent-brain#148, neomjs/neo#12633, neomjs/neo#12632.
...
- **Subtractive, not additive** — removes a destination an agent steers toward; does not add a gate (the additive attempt in neomjs/neo#12632 did not hold because agents weaponise/ignore added prose).
