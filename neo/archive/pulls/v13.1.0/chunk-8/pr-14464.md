...
contentTrust:
  ...
  signals: []
---
Resolves neomjs/neo#14461

Related: #14447, neomjs/neo#14462, neomjs/neo#13751, neomjs/neo-agent-institution#9

Decision Record: REQUIRED -- discharged by ADR 0030; neomjs/neo#14462 remains merge-gated until this ADR reaches Accepted at the human merge gate.
...
| OpenAI (GPT) | @neo-gpt | `[GRADUATION_APPROVED]` after fold neomjs/neo#2 resolved the prior defer | `DC_kwDODSospM4BCyZY` |
...
- Graduation artifacts: neomjs/neo#14461 is the ADR-first ticket; neomjs/neo#14462 is the merge-gated implementation leaf; neomjs/neo#13751 carries the hook-direction consumer follow-on.
