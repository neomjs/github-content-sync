...
- [ ] Once the preview renderer (PR neomjs/neo#13109) and `DockLayoutAdapter` both land, confirm an end-to-end drop applies a `previewToOperation` descriptor through `applyOperation` and the adapter renders the committed tree (whitebox-e2e).
