...
Resolves neomjs/neo#13155

The side-effecting **"act"** leaf completing the Fleet Manager repo-provisioning trio: neomjs/neo#13145 / PR neomjs/neo#13146 derives the path (the "where"), neomjs/neo#13148 / PR neomjs/neo#13149 inspects the checkout state (the "what's there" → a `provisioningAction`), and `ai/services/fleet/provisionAgentRepo.mjs` **executes** that action — materializing the managed checkout under the hood, the operator's *"repos managed under the hood."*
