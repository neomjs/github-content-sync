...
- [ ] neomjs/neo#13120 relocation still owns reusable `src/` placement; this PR should not be treated as a core-layout lift.

## Commits

- `9f22de7c2` — `docs(agentos): define dock layout persistence boundary (#13127)`

Related: neomjs/neo#13030, neomjs/neo-agent-brain#144, neomjs/neo#13120.
