...
This is the hook-READ side; the daemon-WRITE side (compute lane-state → file, retiring the wake-*interrupt*) is a sibling lane under neomjs/neo-agent-brain#136.
...
## Deltas from ticket
None — delivers neomjs/neo#13678's ACs (board-inject + fail-open + mirror-pointer + file-contract + tests).
...
## Related
Part of neomjs/neo-agent-brain#136 (mechanical-enforcement — the enrich-half of the heartbeat-repurpose). The hook: neomjs/neo#13651. Deference-lint twin: neomjs/neo#13674.
