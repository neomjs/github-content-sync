...
- [x] **`[ADDRESSED]`** Track the durable fix before the bug auto-closes.
      **Follow-up ticket:** neomjs/neo#13636
      **Details:** neomjs/neo#13631 was already merged and neomjs/neo#13480 auto-closed, so I filed neomjs/neo#13636 as the successor for nonce-backed Codex wake submit causality proof. It preserves the residual that neomjs/neo#13631 intentionally left: timestamp-window `wake-submit-started` evidence cannot prove scripted Enter versus later human Enter.
