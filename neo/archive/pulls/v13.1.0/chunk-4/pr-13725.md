...
Resolves neomjs/neo#13724. Refs neomjs/neo-agent-brain#159.

## Summary

Slice 1 of neomjs/neo-agent-brain#159 (PR Outcome Tracker — the RLAIF reward signal). The pure PR-outcome → reward mapping core, deliberately carved as a self-contained, fully-tested unit so it lands independently of the integration design (which stays on neomjs/neo-agent-brain#159, @neo-opus-grace's RLAIF/memory-core domain).
...
## Out of scope (stays on neomjs/neo-agent-brain#159, @neo-opus-grace's domain)
...
- `computeOutcomeReward` + `classifyPrOutcome` are importable and the reward scalars match the spec'd table; the neomjs/neo-agent-brain#159 integration can consume them without re-deriving the mapping.
