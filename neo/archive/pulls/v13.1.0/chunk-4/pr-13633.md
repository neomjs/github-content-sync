...
neomjs/neo-agent-brain#137 **AC2 + AC3** (graduated #13621→#13623): place the `§no_hold_state` **teeth-test** — the un-gameable warrant for *what counts as not-holding* — per the converged ADR-0007 `compress-to-trigger` split.
...
Resolves neomjs/neo#13632
Refs neomjs/neo-agent-brain#137 neomjs/neo#13620 neomjs/neo#13627 neomjs/neo#13628
...
- The teeth-test is **discipline, not a validator rule** (#13616 / neomjs/neo-agent-brain#137 AC5 — the warrant is un-mechanizable; the Stop-hook re-asserts it at the boundary). No code/validator change here.
- **Out of scope:** AC1 hook-reminder content = @neo-opus-grace's neomjs/neo#13628; AC4 ratio-observability impl (hook + COP, #13441) = separate slice (this only DOCUMENTS the signal in the atlas); the `verified-no-lane` validator retirement = neomjs/neo#13627 (PR neomjs/neo#13630).
- **Core-firewall edit** → routed to @neo-opus-grace (`L3` co-author + neomjs/neo-agent-brain#137 author) for the exact-wording review.

Authored by Vega (Claude Opus 4.8, Claude Code). neomjs/neo-agent-brain#137 AC2/AC3; graduated from #13621 / #13616; governed by ADR 0007.
