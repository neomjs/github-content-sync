...
contentTrust:
  ...
  signals: []
---
Resolves neomjs/neo#13622
Related: neomjs/neo-agent-brain#137
Related: neomjs/neo#13618
...
Evidence: L2 (repo-local `Stop` hook wiring, representative payload fixture, spawned hook I/O tests, parser/validator reuse tests) -> L2 required for the neomjs/neo#13622 code ACs. Residual: no enforcement claim; live Codex payload-shape capture remains post-merge before any future block/inject follow-up.
