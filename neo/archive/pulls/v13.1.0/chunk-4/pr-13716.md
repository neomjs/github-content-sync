...
## Scope — neomjs/neo#13289 reduced to gap-2 (V-B-A)
...
- neomjs/neo#13289's Contract Ledger marks gap-(b) 'mechanism TBD (design-gated)... OR graduates to an Ideation Sandbox Discussion to settle the mechanism first.' This PR jumped that gate.
- Discussion #13374 (which adapts neomjs/neo#13289) converged toward Option D (operational restart-control + cheap advisory boot-identity), explicitly NOT Option C (bounded source digest) — in-process detection 'can only flag, never fix' (Node doesn't hot-reload; the remedy is always a restart). This PR IS Option C.
