...
Evidence: L2 (focused hook unit specs cover the shared helper plus Claude/Codex reminder text) -> L2 required (runtime reminder schema/gotcha display is unit-coverable). No residuals for neomjs/neo#13731.

## Deltas from ticket
The ticket was created after implementation to provide the required narrow leaf close target. It codifies the neomjs/neo-agent-brain#137 Contract Ledger comment and preserves the neomjs/neo#13643 boundary: no loaded skill-rule re-expansion, only runtime on-block reminder content.
...
## Residuals
neomjs/neo-agent-brain#137 remains open for the broader AC4 ratio-over-window and COP observability work.
