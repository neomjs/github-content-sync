...
Non-loaded recovery (a `learn/` guide is on-demand, not always-loaded substrate) — aligns with neomjs/neo-agent-brain#136's reduction philosophy rather than adding loaded bloat.
