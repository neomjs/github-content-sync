...
updatedAt: '2026-09-19T21:38:09Z'
closed: true
closedAt: '2026-09-19T21:38:09Z'
...
> ## `[GRADUATED_TO_TICKET: neomjs/neo#10357]` — whole-discussion graduation. Closed 2026-09-19.
>
> Graduated to **neomjs/neo#10357** (*Phase 3 cross-harness autonomous wake substrate*), which is **CLOSED/COMPLETED**. The work shipped; this thread stayed open because nobody returned to stamp it, and every scan since has reported it as "resolved to ACs, never graduated".
>
> Found by a reverse lookup — *does any issue body say it graduated from this discussion?* — validated against a five-case control before use. Marker qualified by repository name so it survives a split.
>
