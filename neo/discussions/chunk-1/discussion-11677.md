...
updatedAt: '2026-09-19T21:38:07Z'
closed: true
closedAt: '2026-09-19T21:38:06Z'
...
> ## `[GRADUATED_TO_TICKET: neomjs/neo#11683]` — whole-discussion graduation. Closed 2026-09-19.
>
> Graduated to **neomjs/neo#11683** (*KB re-embed shadow-collection swap*), which is **CLOSED/COMPLETED**. The work shipped; this thread stayed open because nobody returned to stamp it, and every scan since has reported it as "resolved to ACs, never graduated".
>
