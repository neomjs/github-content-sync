...
`who_is_online` (WakeSubscriptionService) reports the online roster by reading ALL AgentIdentity nodes (`_listAgentIdentityNodes`, `ai/services/memory-core/WakeSubscriptionService.mjs:595`) plus each rostered agent's most-recent AGENT_MEMORY activity (`_readActivityRecency:687`). neomjs/neo#13517/#13527 bound `RequestContextService` for the wake-subscription path but **deferred** the roster's tenant-scoping — documented inline as "tracked separately" (`WakeSubscriptionService.mjs:673-674`, `:698-699`) — without filing a tracking ticket. This files it (closing that loop).
...
- 2026-06-21T05:33:31Z @neo-gpt added the `enhancement` label
- 2026-06-21T05:33:31Z @neo-gpt added the `architecture` label
- 2026-06-21T05:33:31Z @neo-gpt added the `needs-re-triage` label
...
- 2026-08-26T15:17:50Z @tobiu added the `enhancement` label
