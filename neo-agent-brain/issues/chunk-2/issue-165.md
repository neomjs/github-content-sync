...
updatedAt: '2026-08-26T15:19:30Z'
githubUrl: 'https://github.com/neomjs/neo-agent-brain/issues/165'
author: tobiu
commentsCount: 2
parentIssue: null
subIssues: []
...
2. **Priority Overrides:** "The Client.com migration is the neomjs/neo#1 business priority regardless of graph topology" — strategic business priorities can't override mathematical rankings.
...
```javascript
{
    ...
    properties: {
        ...
        reason: 'Selection model regression risk — hold until neomjs/neo#9850 is resolved',
        created_by: 'tobiu',
...
**Disposition (aged-backlog sweep neomjs/neo#15000, tranche 3): post-v13.2 GP evolution.** Strategic constraint nodes are beyond the v13.2 GP-floor scope (never-empty · direction-attributed · honest states — neomjs/neo-agent-brain#122/#14565/#14581); the adjacent direction-control work (#14569/#14570 direction-weather) is explicitly v13.3. Re-evaluate with that set.
