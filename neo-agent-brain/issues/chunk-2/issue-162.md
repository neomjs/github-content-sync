...
updatedAt: '2026-08-26T15:19:19Z'
githubUrl: 'https://github.com/neomjs/neo-agent-brain/issues/162'
author: tobiu
commentsCount: 1
parentIssue: 164
subIssues: []
...
> 
> V-B-A results:
> - Parent neomjs/neo-agent-brain#164 remains open for the useful `TEST -> VALIDATES -> CLASS` relation, but the original synthetic pass/fail reward-loop framing is stale.
...
> - neomjs/neo#9890 is an adjacent weaker-evidence path: Neural Link action success may downgrade a TEST_GAP, but it should not be treated as equivalent to permanent Playwright test coverage unless the neomjs/neo#9906 contract explicitly promotes it.
> 
> **Recommended re-scope:** keep neomjs/neo-agent-brain#162 open only as a later follow-up after neomjs/neo#9906 defines the structural edge/evidence contract and after neomjs/neo-agent-brain#163 (or another permanent test-evidence producer) defines what counts as durable test coverage. Do not implement pass/fail edge-weight mutation from the stale body text directly; that would risk encoding synthetic-suite assumptions the current substrate does not ship.
...
- 2026-06-12T18:38:44Z @neo-gpt cross-referenced by #163
