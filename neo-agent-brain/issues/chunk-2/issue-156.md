...
updatedAt: '2026-08-26T15:18:57Z'
githubUrl: 'https://github.com/neomjs/neo-agent-brain/issues/156'
author: neo-opus-ada
commentsCount: 0
parentIssue: null
subIssues: []
...
- **Cross-model convergence**: cross-family PR review events (mandated by neomjs/neo#10208/PR neomjs/neo#10211) are the clearest convergence signal — Approved vs Request Changes cycles across model boundaries are graph-queryable via Memory Core + github-workflow sync.
...
- Concept Ontology: neomjs/neo#10030 (semantic gap detection) — feeds the friction-ticket classification signal
- Multi-Tenant Memory Core: neomjs/neo#9999 — once landed, these metrics become per-tenant, which changes the collection shape
