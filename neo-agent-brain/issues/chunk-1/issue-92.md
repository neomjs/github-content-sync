...
updatedAt: '2026-08-26T15:09:45Z'
githubUrl: 'https://github.com/neomjs/neo-agent-brain/issues/92'
author: neo-gpt-emmy
commentsCount: 1
parentIssue: null
subIssues: []
...
blocking:
  - '[ ] 93 Cloud deployment: opt-in first-boot restore from latest backup bundle'
---
...
neomjs/neo#15691 and neomjs/neo#15692 now reserve two prerequisite mechanics:

- neomjs/neo#15691: compatibility proof before restore mutation;
- neomjs/neo#15692: provider-free, bounded explicit-vector import batches.
...
3. A restore descriptor is orchestrator-supplied and references a neomjs/neo#15691-validated bundle; the mutation primitive never discovers or selects backups.
4. neomjs/neo#15692 owns bounded import only. It owns no scheduling, durable recovery state, retry policy, shadow promotion, or provider call.
...
4. feed neomjs/neo#15692 bounded batches into the isolated target;
...
| Restore descriptor | neomjs/neo#15691 + orchestrator recovery run | exact run/fingerprint/mode/target/file manifest; no primitive discovery | collision and delta authority | descriptor mutation/mismatch specs |
| Bounded import | neomjs/neo#15692 DatabaseService contracts | explicit-vector batches into isolated target; no providers | subsystem scope | 5k/20k + batch-bound specs |
...
- [ ] neomjs/neo#15691 and neomjs/neo#15692 are closed by reviewed implementations.
...
- bounded importer → neomjs/neo#15692;
- compatibility proof → neomjs/neo#15691;
- first-boot consumer → neomjs/neo-agent-brain#93;
- performance evidence → neomjs/neo#15695.
...
neomjs/neo#14134 · neomjs/neo-agent-brain#93 · neomjs/neo#15689 · neomjs/neo#15691 · neomjs/neo#15692 · neomjs/neo#15695 · Discussion #14032
...
- 2026-07-22T09:45:56Z @neo-gpt-emmy added the `enhancement` label
- 2026-07-22T09:45:57Z @neo-gpt-emmy added the `ai` label
- 2026-07-22T09:45:57Z @neo-gpt-emmy added the `testing` label
- 2026-07-22T09:45:57Z @neo-gpt-emmy added the `architecture` label
- 2026-07-22T09:45:57Z @neo-gpt-emmy cross-referenced by #15694
- 2026-07-22T09:46:52Z @neo-gpt-emmy cross-referenced by #93
...
- live-verified that neomjs/neo-agent-brain#92 is already natively blocked by neomjs/neo#15691 and neomjs/neo#15692, and itself blocks neomjs/neo-agent-brain#93.

**Exit to implementation:** folded v13.2 body + Step-Back + refreshed family-keyed quorum + explicit ADR-0027 amendment/successor disposition + reviewed closure of neomjs/neo#15691/#15692. Until then, no assignment, branch, or PR is warranted.
